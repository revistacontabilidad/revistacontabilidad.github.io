...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(B,w){return"function"==typeof B?function(v){try{m(B(v))}catch(u){p(u)}}:w}var m,p,q=new f(function(B,w){m=B;p=w});this.callWhenSettled_(l(h,m),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
p){function q(v){return function(u){B[v]=u;w--;0==w&&m(B)}}var B=[],w=0;do B.push(void 0),w++,d(l.value).callWhenSettled_(q(B.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.owns=function(b,c){return Object.prototype.hasOwnProperty.call(b,c)};$jscomp.polyfill("Object.values",function(b){return b?b:function(c){var d=[],e;for(e in c)$jscomp.owns(c,e)&&d.push(c[e]);return d}},"es8","es3");$jscomp.checkEs6ConformanceViaProxy=function(){try{var b={},c=Object.create(new $jscomp.global.Proxy(b,{get:function(d,e,f){return d==b&&"q"==e&&f==c}}));return!0===c.q}catch(d){return!1}};
$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();
$jscomp.polyfill("WeakMap",function(b){function c(){if(!b||!Object.seal)return!1;try{var m=Object.seal({}),p=Object.seal({}),q=new b([[m,2],[p,3]]);if(2!=q.get(m)||3!=q.get(p))return!1;q.delete(m);q.set(p,4);return!q.has(m)&&4==q.get(p)}catch(B){return!1}}function d(){}function e(m){var p=typeof m;return"object"===p&&null!==m||"function"===p}function f(m){if(!$jscomp.owns(m,h)){var p=new d;$jscomp.defineProperty(m,h,{value:p})}}function g(m){if(!$jscomp.ISOLATE_POLYFILLS){var p=Object[m];p&&(Object[m]=
function(q){if(q instanceof d)return q;Object.isExtensible(q)&&f(q);return p(q)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(b&&$jscomp.ES6_CONFORMANCE)return b}else if(c())return b;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var k=0,l=function(m){this.id_=(k+=Math.random()+1).toString();if(m){m=$jscomp.makeIterator(m);for(var p;!(p=m.next()).done;)p=p.value,this.set(p[0],p[1])}};l.prototype.set=function(m,p){if(!e(m))throw Error("Invalid WeakMap key");
f(m);if(!$jscomp.owns(m,h))throw Error("WeakMap key fail: "+m);m[h][this.id_]=p;return this};l.prototype.get=function(m){return e(m)&&$jscomp.owns(m,h)?m[h][this.id_]:void 0};l.prototype.has=function(m){return e(m)&&$jscomp.owns(m,h)&&$jscomp.owns(m[h],this.id_)};l.prototype.delete=function(m){return e(m)&&$jscomp.owns(m,h)&&$jscomp.owns(m[h],this.id_)?delete m[h][this.id_]:!1};return l},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(b){function c(){if($jscomp.ASSUME_NO_NATIVE_MAP||!b||"function"!=typeof b||!b.prototype.entries||"function"!=typeof Object.seal)return!1;try{var l=Object.seal({x:4}),m=new b($jscomp.makeIterator([[l,"s"]]));if("s"!=m.get(l)||1!=m.size||m.get({x:4})||m.set({x:4},"t")!=m||2!=m.size)return!1;var p=m.entries(),q=p.next();if(q.done||q.value[0]!=l||"s"!=q.value[1])return!1;q=p.next();return q.done||4!=q.value[0].x||"t"!=q.value[1]||!p.next().done?!1:!0}catch(B){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(b&&$jscomp.ES6_CONFORMANCE)return b}else if(c())return b;var d=new WeakMap,e=function(l){this.data_={};this.head_=h();this.size=0;if(l){l=$jscomp.makeIterator(l);for(var m;!(m=l.next()).done;)m=m.value,this.set(m[0],m[1])}};e.prototype.set=function(l,m){l=0===l?0:l;var p=f(this,l);p.list||(p.list=this.data_[p.id]=[]);p.entry?p.entry.value=m:(p.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:l,value:m},p.list.push(p.entry),
...
f(this,l).entry)&&l.value};e.prototype.entries=function(){return g(this,function(l){return[l.key,l.value]})};e.prototype.keys=function(){return g(this,function(l){return l.key})};e.prototype.values=function(){return g(this,function(l){return l.value})};e.prototype.forEach=function(l,m){for(var p=this.entries(),q;!(q=p.next()).done;)q=q.value,l.call(m,q[1],q[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=function(l,m){var p=m&&typeof m;"object"==p||"function"==p?d.has(m)?p=d.get(m):
(p=""+ ++k,d.set(m,p)):p="p_"+m;var q=l.data_[p];if(q&&$jscomp.owns(l.data_,p))for(l=0;l<q.length;l++){var B=q[l];if(m!==m&&B.key!==B.key||m===B.key)return{id:p,list:q,index:l,entry:B}}return{id:p,list:q,index:-1,entry:void 0}},g=function(l,m){var p=l.head_;return $jscomp.iteratorPrototype(function(){if(p){for(;p.head!=l.head_;)p=p.previous;for(;p.next!=p.head;)return p=p.next,{done:!1,value:m(p)};p=null}return{done:!0,value:void 0}})},h=function(){var l={};return l.previous=l.next=l.head=l},k=0;
return e},"es6","es3");$jscomp.polyfill("Array.prototype.flat",function(b){return b?b:function(c){c=void 0===c?1:c;for(var d=[],e=0;e<this.length;e++){var f=this[e];Array.isArray(f)&&0<c?(f=Array.prototype.flat.call(f,c-1),d.push.apply(d,f)):d.push(f)}return d}},"es9","es5");
...
(function(b,c,d,e){function f(n,r,t){return setTimeout(m(n,t),r)}function g(n,r,t){return Array.isArray(n)?(h(n,t[r],t),!0):!1}function h(n,r,t){var z;if(n)if(n.forEach)n.forEach(r,t);else if(n.length!==e)for(z=0;z<n.length;)r.call(t,n[z],z,n),z++;else for(z in n)n.hasOwnProperty(z)&&r.call(t,n[z],z,n)}function k(n,r,t){var z="DEPRECATED METHOD: "+r+"\n"+t+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,z,C);return n.apply(this,arguments)}}function l(n,r,t){r=r.prototype;var z=n.prototype=Object.create(r);z.constructor=n;z._super=r;t&&S(z,t)}function m(n,r){return function(){return n.apply(r,arguments)}}function p(n,r){return"function"==typeof n?n.apply(r?r[0]||e:e,r):n}function q(n,r,t){h(v(r),function(z){"undefined"!=typeof b.addEventListener?n.addEventListener(z,t,!1):n.attachEvent(z,t)})}
function B(n,r,t){h(v(r),function(z){"undefined"!=typeof b.removeEventListener?n.removeEventListener(z,t,!1):n.detachEvent(z,t,!1)})}function w(n,r){for(;n;){if(n==r)return!0;n=n.parentNode}return!1}function v(n){return n.trim().split(/\s+/g)}function u(n,r,t){if(n.indexOf&&!t)return n.indexOf(r);for(var z=0;z<n.length;){if(t&&n[z][t]==r||!t&&n[z]===r)return z;z++}return-1}function x(n){return Array.prototype.slice.call(n,0)}function y(n,r,t){for(var z=[],C=[],D=0;D<n.length;){var E=r?n[D][r]:n[D];
0>u(C,E)&&z.push(n[D]);C[D]=E;D++}t&&(z=r?z.sort(function(J,P){return J[r]>P[r]}):z.sort());return z}function A(n,r){if(r&&r[0]){for(var t,z=r[0].toUpperCase()+r.slice(1),C=0;C<oa.length;){t=(t=oa[C])?t+z:r;if(t in n)return t;C++}return e}}function G(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function F(n,r){var t=this;this.manager=n;this.callback=r;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(z){p(n.options.enable,[n])&&t.handler(z)};this.init()}
function O(n,r,t){var z=t.pointers.length,C=t.changedPointers.length;var D=r&1&&0===z-C;t.isFirst=!!D;t.isFinal=!!(r&12&&0===z-C);D&&(n.session={});t.eventType=r;r=n.session;z=t.pointers;C=z.length;r.firstInput||(r.firstInput=L(t));1<C&&!r.firstMultiple?r.firstMultiple=L(t):1===C&&(r.firstMultiple=!1);D=r.firstInput;var E=(C=r.firstMultiple)?C.center:D.center;var J=t.center=H(z);t.timeStamp=fa();t.deltaTime=t.timeStamp-D.timeStamp;t.angle=M(E,J);t.distance=K(E,J);D=t.center;E=r.offsetDelta||{};J=
...
t.pointers.length>r.prevInput.maxPointers?t.pointers.length:r.prevInput.maxPointers:t.pointers.length;E=r.lastInterval||t;z=t.timeStamp-E.timeStamp;8!=t.eventType&&(25<z||E.velocity===e)?(D=t.deltaX-E.deltaX,E=t.deltaY-E.deltaY,J=D/z||0,P=E/z||0,z=J,C=P,J=V(J)>V(P)?J:P,D=I(D,E),r.lastInterval=t):(J=E.velocity,z=E.velocityX,C=E.velocityY,D=E.direction);t.velocity=J;t.velocityX=z;t.velocityY=C;t.direction=D;r=n.element;w(t.srcEvent.target,r)&&(r=t.srcEvent.target);t.target=r;n.emit("hammer.input",t);
n.recognize(t);n.session.prevInput=t}function L(n){for(var r=[],t=0;t<n.pointers.length;)r[t]={clientX:X(n.pointers[t].clientX),clientY:X(n.pointers[t].clientY)},t++;return{timeStamp:fa(),pointers:r,center:H(r),deltaX:n.deltaX,deltaY:n.deltaY}}function H(n){var r=n.length;if(1===r)return{x:X(n[0].clientX),y:X(n[0].clientY)};for(var t=0,z=0,C=0;C<r;)t+=n[C].clientX,z+=n[C].clientY,C++;return{x:X(t/r),y:X(z/r)}}function I(n,r){return n===r?1:V(n)>=V(r)?0>n?2:4:0>r?8:16}function K(n,r,t){t||(t=pa);var z=
r[t[0]]-n[t[0]];n=r[t[1]]-n[t[1]];return Math.sqrt(z*z+n*n)}function M(n,r,t){t||(t=pa);return 180*Math.atan2(r[t[1]]-n[t[1]],r[t[0]]-n[t[0]])/Math.PI}function W(){this.evEl=za;this.evWin=Aa;this.pressed=!1;F.apply(this,arguments)}function Z(){this.evEl=qa;this.evWin=ra;F.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function aa(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;F.apply(this,arguments)}function T(){this.evTarget=
Ba;this.targetIds={};F.apply(this,arguments)}function U(n,r){var t=x(n.touches),z=this.targetIds;if(r&3&&1===t.length)return z[t[0].identifier]=!0,[t,t];n=x(n.changedTouches);var C=[],D=this.target;var E=t.filter(function(J){return w(J.target,D)});if(1===r)for(t=0;t<E.length;)z[E[t].identifier]=!0,t++;for(t=0;t<n.length;)z[n[t].identifier]&&C.push(n[t]),r&12&&delete z[n[t].identifier],t++;if(C.length)return[y(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var n=m(this.handler,
this);this.touch=new T(this.manager,n);this.mouse=new W(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function sa(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var r={x:n.clientX,y:n.clientY};this.lastTouches.push(r);var t=this.lastTouches;setTimeout(function(){var z=t.indexOf(r);-1<z&&t.splice(z,1)},2500)}}function ia(n,r){this.manager=n;this.set(r)}function Ca(n){if(-1<n.indexOf("none"))return"none";var r=-1<n.indexOf("pan-x"),t=-1<n.indexOf("pan-y");return r&&t?"none":
r||t?r?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function Q(n){this.options=S({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ta(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function ua(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function ba(n,r){return(r=r.manager)?r.get(n):n}function N(){Q.apply(this,arguments)}function ca(){N.apply(this,
arguments);this.pY=this.pX=null}function ja(){N.apply(this,arguments)}function ka(){Q.apply(this,arguments);this._input=this._timer=null}function la(){N.apply(this,arguments)}function ma(){N.apply(this,arguments)}function da(){Q.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function R(n,r){r=r||{};var t=r.recognizers;r.recognizers=t===e?R.defaults.preset:t;return new na(n,r)}function na(n,r){this.options=S({},R.defaults,r||{});this.options.inputTarget=
this.options.inputTarget||n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ha(this,O);this.touchAction=new ia(this,this.options.touchAction);va(this,!0);h(this.options.recognizers,function(t){var z=this.add(new t[0](t[1]));t[2]&&z.recognizeWith(t[2]);t[3]&&z.requireFailure(t[3])},this)}function va(n,r){var t=n.element;if(t.style){var z;h(n.options.cssProps,function(C,D){z=A(t.style,D);r?(n.oldCssProps[z]=t.style[z],t.style[z]=C):t.style[z]=n.oldCssProps[z]||
""});r||(n.oldCssProps={})}}function Ea(n,r){var t=c.createEvent("Event");t.initEvent(n,!0,!0);t.gesture=r;r.target.dispatchEvent(t)}var oa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),X=Math.round,V=Math.abs,fa=Date.now;var S="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var r=Object(n),t=1;t<arguments.length;t++){var z=arguments[t];if(z!==e&&null!==z)for(var C in z)z.hasOwnProperty(C)&&(r[C]=z[C])}return r}:
Object.assign;var wa=k(function(n,r,t){for(var z=Object.keys(r),C=0;C<z.length;){if(!t||t&&n[z[C]]===e)n[z[C]]=r[z[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,r){return wa(n,r,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var pa=["x","y"],Y=["clientX","clientY"];F.prototype={handler:function(){},init:function(){this.evEl&&q(this.element,this.evEl,this.domHandler);this.evTarget&&
q(this.target,this.evTarget,this.domHandler);this.evWin&&q(G(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&B(this.element,this.evEl,this.domHandler);this.evTarget&&B(this.target,this.evTarget,this.domHandler);this.evWin&&B(G(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},za="mousedown",Aa="mousemove mouseup";l(W,F,{handler:function(n){var r=Ja[n.type];r&1&&0===n.button&&(this.pressed=!0);r&2&&1!==n.which&&(r=4);this.pressed&&(r&4&&
(this.pressed=!1),this.callback(this.manager,r,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},qa="pointerdown",ra="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(qa="MSPointerDown",ra="MSPointerMove MSPointerUp MSPointerCancel");l(Z,F,{handler:function(n){var r=this.store,t=!1,z=n.type.toLowerCase().replace("ms","");z=Ka[z];var C=
La[n.pointerType]||n.pointerType,D="touch"==C,E=u(r,n.pointerId,"pointerId");z&1&&(0===n.button||D)?0>E&&(r.push(n),E=r.length-1):z&12&&(t=!0);0>E||(r[E]=n,this.callback(this.manager,z,{pointers:r,changedPointers:[n],pointerType:C,srcEvent:n}),t&&r.splice(E,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(aa,F,{handler:function(n){var r=Ma[n.type];1===r&&(this.started=!0);if(this.started){var t=x(n.touches);var z=x(n.changedTouches);r&12&&(t=y(t.concat(z),"identifier",!0));t=[t,
z];r&12&&0===t[0].length-t[1].length&&(this.started=!1);this.callback(this.manager,r,{pointers:t[0],changedPointers:t[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ba="touchstart touchmove touchend touchcancel";l(T,F,{handler:function(n){var r=Na[n.type],t=U.call(this,n,r);t&&this.callback(this.manager,r,{pointers:t[0],changedPointers:t[1],pointerType:"touch",srcEvent:n})}});l(ha,F,{handler:function(n,r,t){var z="mouse"==t.pointerType;if(!(z&&t.sourceCapabilities&&
t.sourceCapabilities.firesTouchEvents)){if("touch"==t.pointerType)r&1?(this.primaryTouch=t.changedPointers[0].identifier,sa.call(this,t)):r&12&&sa.call(this,t);else{if(z)a:{z=t.srcEvent.clientX;for(var C=t.srcEvent.clientY,D=0;D<this.lastTouches.length;D++){var E=this.lastTouches[D],J=Math.abs(C-E.y);if(25>=Math.abs(z-E.x)&&25>=J){z=!0;break a}}z=!1}if(z)return}this.callback(n,r,t)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var xa=A(Fa.style,"touchAction"),ya=xa!==e,ea=function(){if(!ya)return!1;
var n={},r=b.CSS&&b.CSS.supports;"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(t){n[t]=r?b.CSS.supports("touch-action",t):!0});return n}();ia.prototype={set:function(n){"compute"==n&&(n=this.compute());ya&&this.manager.element.style&&ea[n]&&(this.manager.element.style[xa]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(r){p(r.options.enable,[r])&&(n=
n.concat(r.getTouchAction()))});return Ca(n.join(" "))},preventDefaults:function(n){var r=n.srcEvent,t=n.offsetDirection;if(this.manager.session.prevented)r.preventDefault();else{var z=this.actions,C=-1<z.indexOf("none")&&!ea.none,D=-1<z.indexOf("pan-y")&&!ea["pan-y"];z=-1<z.indexOf("pan-x")&&!ea["pan-x"];if(C){var E=2>n.distance,J=250>n.deltaTime;if(1===n.pointers.length&&E&&J)return}if(!z||!D)if(C||D&&t&6||z&&t&24)return this.preventSrc(r)}},preventSrc:function(n){this.manager.session.prevented=
!0;n.preventDefault()}};Q.prototype={defaults:{},set:function(n){S(this.options,n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var r=this.simultaneous;n=ba(n,this);r[n.id]||(r[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=ba(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;
var r=this.requireFail;n=ba(n,this);-1===u(r,n)&&(r.push(n),n.requireFailure(this));return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=ba(n,this);n=u(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function r(C){t.manager.emit(C,n)}var t=this,z=this.state;8>z&&r(t.options.event+ta(z));r(t.options.event);
n.additionalEvent&&r(n.additionalEvent);8<=z&&r(t.options.event+ta(z))},tryEmit:function(n){if(this.canEmit())return this.emit(n);this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=S({},n);p(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};
l(N,Q,{defaults:{pointers:1},attrTest:function(n){var r=this.options.pointers;return 0===r||n.pointers.length===r},process:function(n){var r=this.state,t=n.eventType,z=r&6;n=this.attrTest(n);return z&&(t&8||!n)?r|16:z||n?t&4?r|8:r&2?r|4:2:32}});l(ca,N,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,r=[];n&6&&r.push("pan-y");n&24&&r.push("pan-x");return r},directionTest:function(n){var r=this.options,t=!0,z=n.distance,C=n.direction,
D=n.deltaX,E=n.deltaY;C&r.direction||(r.direction&6?(C=0===D?1:0>D?2:4,t=D!=this.pX,z=Math.abs(n.deltaX)):(C=0===E?1:0>E?8:16,t=E!=this.pY,z=Math.abs(n.deltaY)));n.direction=C;return t&&z>r.threshold&&C&r.direction},attrTest:function(n){return N.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var r=ua(n.direction);r&&(n.additionalEvent=this.options.event+r);this._super.emit.call(this,n)}});l(ja,N,{defaults:{event:"pinch",
threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ka,Q,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var r=this.options,t=n.pointers.length===r.pointers,z=n.distance<
r.threshold,C=n.deltaTime>r.time;this._input=n;if(!z||!t||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),this._timer=f(function(){this.state=8;this.tryEmit()},r.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=fa(),this.manager.emit(this.options.event,this._input)))}});l(la,N,{defaults:{event:"rotate",threshold:0,
pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>this.options.threshold||this.state&2)}});l(ma,N,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return ca.prototype.getTouchAction.call(this)},attrTest:function(n){var r=this.options.direction;if(r&30)var t=n.overallVelocity;else r&6?t=n.overallVelocityX:r&24&&(t=n.overallVelocityY);return this._super.attrTest.call(this,
n)&&r&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&V(t)>this.options.velocity&&n.eventType&4},emit:function(n){var r=ua(n.offsetDirection);r&&this.manager.emit(this.options.event+r,n);this.manager.emit(this.options.event,n)}});l(da,Q,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var r=this.options,t=n.pointers.length===r.pointers,z=n.distance<
r.threshold,C=n.deltaTime<r.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(z&&C&&t){if(4!=n.eventType)return this.failTimeout();t=this.pTime?n.timeStamp-this.pTime<r.interval:!0;z=!this.pCenter||K(this.pCenter,n.center)<r.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=z&&t?this.count+1:1;this._input=n;if(0===this.count%r.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},r.interval,this),2):8}return 32},
...
taps:2},["tap"]],[ka]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};na.prototype={set:function(n){S(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var r=this.session;if(!r.stopped){this.touchAction.preventDefaults(n);var t=this.recognizers,
z=r.curRecognizer;if(!z||z&&z.state&8)z=r.curRecognizer=null;for(var C=0;C<t.length;){var D=t[C];2===r.stopped||z&&D!=z&&!D.canRecognizeWith(z)?D.reset():D.recognize(n);!z&&D.state&14&&(z=r.curRecognizer=D);C++}}},get:function(n){if(n instanceof Q)return n;for(var r=this.recognizers,t=0;t<r.length;t++)if(r[t].options.event==n)return r[t];return null},add:function(n){if(g(n,"add",this))return this;var r=this.get(n.options.event);r&&this.remove(r);this.recognizers.push(n);n.manager=this;this.touchAction.update();
return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var r=this.recognizers;n=u(r,n);-1!==n&&(r.splice(n,1),this.touchAction.update())}return this},on:function(n,r){if(n!==e&&r!==e){var t=this.handlers;h(v(n),function(z){t[z]=t[z]||[];t[z].push(r)});return this}},off:function(n,r){if(n!==e){var t=this.handlers;h(v(n),function(z){r?t[z]&&t[z].splice(u(t[z],r),1):delete t[z]});return this}},emit:function(n,r){this.options.domEvents&&Ea(n,r);var t=this.handlers[n]&&this.handlers[n].slice();
if(t&&t.length)for(r.type=n,r.preventDefault=function(){r.srcEvent.preventDefault()},n=0;n<t.length;)t[n](r),n++},destroy:function(){this.element&&va(this,!1);this.handlers={};this.session={};this.input.destroy();this.element=null}};S(R,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,
DIRECTION_VERTICAL:24,DIRECTION_ALL:30,Manager:na,Input:F,TouchAction:ia,TouchInput:T,MouseInput:W,PointerEventInput:Z,TouchMouseInput:ha,SingleTouchInput:aa,Recognizer:Q,AttrRecognizer:N,Tap:da,Pan:ca,Swipe:ma,Pinch:ja,Rotate:la,Press:ka,on:q,off:B,each:h,merge:Ga,extend:wa,assign:S,inherit:l,bindFn:m,prefixed:A});("undefined"!==typeof b?b:"undefined"!==typeof self?self:{}).Hammer=R;"function"===typeof define&&define.amd?define(function(){return R}):"undefined"!=typeof module&&module.exports?module.exports=
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,p=0,q=0;f.animateInterval=function(B,w){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*(g-1),20);p=$.easing.swing(null,m,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var v=0;v<f.side.pageArray.length;v++)if(f.side.pageArray[v])f.side.pageArray[v].onResize(k/2,l);m++;if(20<=m||B>=w){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
...
(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var m=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,q=e*k,B=0,w=0,v=0,u=0;toolBar&&(B=0===toolBar.getTopHeight()?
0:toolBar.getTopHeight()+10,w=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,v=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var x=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+v}else x=-l-h*e*d.parameters.zoomArea.left/100+v,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-u;q>windowHeight?(h=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-
w,d=-m-k*e*d.parameters.zoomArea.top/100+B):(h=-m-k*e*d.parameters.zoomArea.top/100+B,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-w);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){m(p,q,"Sine")}).animation(this,300)}.bind(this),m=function(p,q,B){if(p<q){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var w=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=p;q.tran={x:B,
y:w};B=transformCSS(q);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),p=getHost();if(m&&p!==m){if(g=f.src.replace(m,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(u){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),B=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var w=Color(b).split();k=0;for(var v=q.data.length;k<v;k+=4)0<B.data[k+3]&&(q.data[k]!=w.r&&(B.data[k]=q.data[k]/255*w.r),q.data[k+1]!=w.g&&(B.data[k+1]=
q.data[k+1]/255*w.g),q.data[k+2]!=w.b&&(B.data[k+2]=q.data[k+2]/255*w.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
$.fn.speed=function(b){function c(v){v=void 0==v.originalEvent.touches?[v]:v.originalEvent.touches;if(1<v.length)return q=!0;f=h=v[0].pageX;g=k=v[0].pageY;l=new Date;-1!=p&&window.clearInterval(p);p=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(v){if(-1==p||1==q)return!0;v=void 0==v.originalEvent.touches?[v]:v.originalEvent.touches;h=v[0].pageX;k=v[0].pageY}function e(v){if(-1==p)return!0;v=void 0!=v.originalEvent.touches==0?[v]:v.originalEvent.touches;if(1==q)return q=1<v.length,
!0;m=new Date;v=(m-l)/20;var u=h-f,x=k-g;0==v?w=B=0:(B=u/v,w=x/v);void 0!=b&&b(B,w);window.clearInterval(p);p=-1}var f,g,h,k,l,m,p=-1,q=!1,B=0,w=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(v){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(v){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",p=-1,q,B,w,v=k.length-l;++p<v;)q=k.charCodeAt(p)<<
16,B=k.charCodeAt(++p)<<8,w=k.charCodeAt(++p),q=q+B+w,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,B=k.charCodeAt(++p),q+=B,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,p,q,B="",w=-1;++w<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(w)),
...
function resizeDocumentViewBook(){if(bookType==BookType.documentView_book||bookType==BookType.singleDocumentView_book){if(global.singleDocumentViewBook)singleDocumentViewBook.onResize();if(global.singleDocumentViewBook)singleDocumentViewBook.onResize()}}
...
(bookType=BookType.single_book,changeShowBook(bookType),c=flipBook.currentPageIndex,b=!0);bookType==BookType.documentView_book&&windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage&&(bookType=BookType.singleDocumentView_book,changeShowBook(bookType),c=singleDocumentViewBook.currentPageIndex,b=!0);resizeFlipBook();resizeCatalogBook();resizeSlideBook();resizeDocumentViewBook();b&&(gotoPageFun(c,!1,"change book type"),global.thumbnail&&thumbnail.clearHighLight(),global.thumbnail&&thumbnail.setHighLight(c))}}
...
b=!0);bookType==BookType.documentView_book&&windowWidth>=windowHeight&&"auto"==bookConfig.showDoublePage&&(bookType=BookType.singleDocumentView_book,changeShowBook(bookType),c=singleDocumentViewBook.currentPageIndex,b=!0);resizeFlipBook();resizeCatalogBook();resizeSlideBook();resizeDocumentViewBook();b&&(gotoPageFun(c,!1,"change book type"),global.thumbnail&&thumbnail.clearHighLight(),global.thumbnail&&thumbnail.setHighLight(c))}
...
function initDocumentViewBook(b,c){if(bookType==BookType.documentView_book||bookType==BookType.singleDocumentView_book)if(console.log("initDocumentViewBook"),$.extend(b,{thickness:!1,bookshadow:!1,grayshadow:!1,miniFullscreen:!1,bookpagenumber:!1,staticad:!1,zoommap:!1,bookmarktab:!1,noteadd:!0}),$.extend(c,{thickness:!1,bookshadow:!1,grayshadow:!1,miniFullscreen:!1,bookpagenumber:!1,staticad:!1,zoommap:!1,bookmarktab:!1,noteadd:!0}),bookType==BookType.documentView_book||bookType==BookType.singleDocumentView_book)global.singleDocumentViewBook=
...
function initIssuuBook(b,c){"issuu"!=bookConfig.FlipStyle||bookType!=BookType.normal_book&&bookType!=BookType.single_book||($.extend(b,{thickness:bookConfig.FlipDirection?!1:!0}),$.extend(c,{thickness:bookConfig.showThicknessOnMobile?!0:!1,bookshadow:!0,grayshadow:!1,miniFullscreen:bookConfig.hideMiniFullscreen?!1:!0,bookpagenumber:bookConfig.updatePageNumberForFlip?!0:!1,staticad:getStaticAdVisible(!0),zoommap:bookConfig.ZoomMapVisible?!0:!1,bookmarktab:global.bmtConfig?!0:!1,noteadd:bookConfig.AnnotationButtonVisible?
...
function getArticleTitle(b){for(var c=b.articleTextList,d="",e=-1,f=0;f<c.length;f++)if(0>f)"headline"==c[f].fontType&&(d+=c[f].text,e=f);else if(e===f-1&&"headline"==c[f].fontType)d+=c[f].text,e=f;else break;d||(d=b.title);return d}
...
getConfigValue("EmailButtonVisible",!1);tmpBookConfig.btnShareWithEmailSubject=getConfigValue("btnShareWithEmailSubject","");tmpBookConfig.btnShareWithEmailBody=getConfigValue("btnShareWithEmailBody","");tmpBookConfig.socialShareLink=getConfigValue("socialShareLink","");tmpBookConfig.VideoButtonVisible=getConfigValue("VideoButtonVisible",!1);if(!global.videoList||0>=global.videoList.length)tmpBookConfig.VideoButtonVisible=!1;tmpBookConfig.SlideshowButtonVisible=getConfigValue("SlideshowButtonVisible",
!1);if(!global.slideshow||0>=global.slideshow.length)tmpBookConfig.SlideshowButtonVisible=!1;tmpBookConfig.CompanyLogoFile=getConfigValue("CompanyLogoFile","");tmpBookConfig.UIBaseURL=getConfigValue("UIBaseURL","");tmpBookConfig.haveAdSense=getConfigValue("haveAdSense",!1);tmpBookConfig.adSenseLeft=getConfigValue("adSenseLeft",0);tmpBookConfig.adSenseTop=getConfigValue("adSenseTop",0);tmpBookConfig.adSenseWidth=getConfigValue("adSenseWidth",0);tmpBookConfig.adSenseHeight=getConfigValue("adSenseHeight",
0);tmpBookConfig.adSenseClientId=getConfigValue("adSenseClientId","");tmpBookConfig.adSenseSlotId=getConfigValue("adSenseSlotId","");tmpBookConfig.productName=getConfigValue("productName","Flip HTML5");tmpBookConfig.homePage=getConfigValue("homePage","http://www.fliphtml5.com");tmpBookConfig.preloadNextPage=getConfigValue("preloadNextPage",!0);tmpBookConfig.showMirrorSide=getConfigValue("showMirrorSide",!0);tmpBookConfig.addPaperCoil=getConfigValue("addPaperCoil",!1);tmpBookConfig.addPaperCoil&&!tmpBookConfig.BindingType&&
...
"files/extfiles/users.js");tmpBookConfig.excludeFrontPages=getConfigValue("excludeFrontPages","");tmpBookConfig.isFlipPdf=getConfigValue("isFlipPdf",!1);tmpBookConfig.SingleModeBanFlipToLastPage=getConfigValue("SingleModeBanFlipToLastPage",!1);tmpBookConfig.isSingleBookFullWindowOnMobile=getConfigValue("isSingleBookFullWindowOnMobile",!1);tmpBookConfig.showGotoButtonsAtFirst=getConfigValue("showGotoButtonsAtFirst",!1);0==tmpBookConfig.isFlipPdf&&void 0!=global.isFlipPdf&&(tmpBookConfig.isFlipPdf=
isFlipPdf);tmpBookConfig.FlipSound=getConfigValue("FlipSound",!0);global.flipSoundIsPlaying=tmpBookConfig.FlipSound;tmpBookConfig.CurlingPageCorner=getConfigValue("CurlingPageCorner",!0);tmpBookConfig.BanFlipFromDirection=getConfigValue("BanFlipFromDirection",!1);tmpBookConfig.iconFontColor=getConfigValue("iconFontColor","#ffffff");try{void 0!=global.staticAd&&1==staticAd.haveAd&&void 0==global.staticAd.adPosition&&("Chinese"==UserGroups&&(global.staticAd.adPosition=1),"English"==UserGroups&&(global.staticAd.adPosition=
0)),void 0!=global.staticAd&&1==staticAd.haveAd&&0===parseInt(global.staticAd.adPosition)?tmpBookConfig.retainBookCenter=!1:tmpBookConfig.retainBookCenter=getConfigValue("retainBookCenter",!0)}catch(l){}tmpBookConfig.updateURLForPage=getConfigValue("updateURLForPage",!0);tmpBookConfig.borderColor=getConfigValue("borderColor","#572f0d");tmpBookConfig.outerCoverBorder=getConfigValue("outerCoverBorder",!1);tmpBookConfig.hardCoverBorderWidth=getConfigValue("hardCoverBorderWidth",0);tmpBookConfig.cornerRound=
...
"");tmpBookConfig.isMouseEnterToDisplayArticleTitle=getConfigValue("isMouseEnterToDisplayArticleTitle",!1);try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(e=0;e<window.ignoreModuleArray.bookConfig.length;e++)f=window.ignoreModuleArray.bookConfig[e],void 0!=tmpBookConfig[f]&&(tmpBookConfig[f]=!1)}catch(l){}checkFliphtml5PagesConfig();checkFlipStyleConfig();return"issuu"==tmpBookConfig.FlipStyle?k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),3):k.yield(loadCSS(tmpBookConfig.UIBaseURL+
"style/flipbook.min.css"),3)}checkPageEditorConfig();recordError();g=Module._getVerifyString();h=UTF8ToString(g);Module._free(g);eval(h);k.jumpToEnd()})};
...
for(var l=0;l<b.length;l++){var m=$(b[l]);"Phone"==m.attr("type")&&(c=m.text());"Link"==m.attr("type")&&(d=m.text());"Email"==m.attr("type")&&(e=m.text());"Address"==m.attr("type")&&(f=m.text());"Author"==m.attr("type")&&(g=m.text())}b=function(p){return String.parseUtf8(base64.decode(p))};f&&!tmpBookConfig.AboutAddress&&(tmpBookConfig.AboutAddress=b(f));e&&!tmpBookConfig.AboutEmail&&(tmpBookConfig.AboutEmail=b(e));c&&!tmpBookConfig.AboutMobile&&(tmpBookConfig.AboutMobile=b(c));d&&!tmpBookConfig.AboutWebsite&&
...
function animateOnce(b,c,d,e,f,g){if(b&&c)if(void 0==d||0===d||isIE9())b.css(c),e&&e instanceof Function&&e();else{var h=!1;setAnimation(b,d,f,g);f=function(){1!=h&&(h=!0,setAnimation(b,0),e&&e instanceof Function&&e())};b.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",f);window.setTimeout(f,5*d);b.css(c)}}
...
var VERSION_NAME="6.4.9",BUILD_DATE="2025051301",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType={WEBKIT:1,
...
35,KEY_CODE_PAGEUP=33,KEY_CODE_PAGEDOWN=34,KEY_CODE_DELETE=46,KEY_CODE_F11=122,KEY_CODE_A=65,MOUSE_LEFT=1,MOUSE_MIDDLE=2,MOUSE_RIGHT=3,LOADING_WIDTH=30,LOADING_HEIGHT=30,COIL_PAGE_WIDTH=500,isTouchDevice=function(){navigator.userAgent.match(/mobile|tablet|ip(ad|hone|od)|android/i);return _agent_.browser.device==_agent_.browser.DEVICE_PHONE||isPad()};isTouch=isTouchDevice();var _event;
...
"("+b+")");b--;0>=b&&(window.clearInterval(this.inteval),this.destroy(),this.initBookStyle("flip_book"))}.bind(this),1E3)},onResize:function(){},destroy:function(){this.container&&(this.container.hide(),this.container.remove(),this.slideModel=this.flipModel=this.bookStyleBox=this.container=void 0)}});bdor[22]="l";bdor[5]="a";bdor.y="y";
...
Class("ZoomButton",{create:function(){this._super();this.bindStates(this.setAsZoomin,this.setAsZoomout);this.initLanguage({btnZoomIn:"Zoom In"},{btnZoomOut:"Zoom Out"});this.setAsZoomin()},setAsZoomin:function(){this.setSrc("ZoomIn",bookConfig.ZoomInButtonIcon);this.changeLanguage();this.changeColor()},setAsZoomout:function(){this.setSrc("ZoomOut",bookConfig.ZoomOutButtonIcon);this.changeLanguage();this.changeColor()},executeZoomout:function(){var b=BookInfo.getBook().showPage;if(bookType===BookType.documentView_book||
bookType===BookType.singleDocumentView_book)b=BookInfo.getBook().docViewBook;b.onDoubleTap.bind(b)({pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]});auto_player.isPlaying()&&auto_player.stop();"popular"==global.templeteName&&setLogoIndex({zIndex:"99"})},executeZoomin:function(){var b=BookInfo.getBook().showPage;if(bookType===BookType.documentView_book||bookType===BookType.singleDocumentView_book)b=BookInfo.getBook().docViewBook;b.onDoubleTap.bind(b)({pointers:[{pageX:windowWidth/2,pageY:windowHeight/
...
Class("SelectTextButton",{create:function(){this._super();this.bindStates(this.setAsUnSelect,this.setAsSelect);this.initLanguage({btnSelectText:"Select Text"},{btnSelectText:"Select Text"});this.setAsUnSelect()},setAsSelect:function(){this.setSrc("text",bookConfig.SelectTextButtonIcon);this.changeColor("#bdc5e9");this.changeLanguage()},setAsUnSelect:function(){this.setSrc("text",bookConfig.SelectTextButtonIcon);this.changeColor();this.changeLanguage()},select:function(b){var c,d,e,f,g,h,k,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){switch(m.nextAddress){case 1:c=
BookInfo.getCurrentPages(),d=0;case 2:if(!(d<c.length)){m.jumpTo(4);break}e=getSearchRealPageIndex(c[d]);if(-1==e){m.jumpTo(3);break}f=!1;for(g=0;g<positionForPages.length;g++)if(positionForPages[g]&&positionForPages[g].page&&positionForPages[g].page==e){f=!0;break}if(f){m.jumpTo(3);break}h=String.format(bookConfig.searchPositionJS,e);1<e&&(h=h.replace("[1]","["+e+"]"));k=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi;l=/\.*\/?(\w+\/)*\w+?\.js/gi;if(!h.match(k)&&!h.match(l)){m.jumpTo(4);break}return m.yield(getArticleImage(fixURLValue(h)),
6);case 6:h=m.yieldResult,loadJavascript(h,function(){},function(){});case 3:d++;m.jumpTo(2);break;case 4:BookInfo.getBook()&&BookInfo.getBook().select(),m.jumpToEnd()}})},unSelect:function(){BookInfo.getBook()&&BookInfo.getBook().unSelect()},onClick:function(){BookInfo.getBook()&&BookInfo.getBook().flipping||(this.status?(this.setAsUnSelect(),this.unSelect(),this.status=0):(this.setAsSelect(),this.select(),this.status=1))}}).extend("ToolbarStateButton");
...
y.push(A.rect))});return y}function m(u,x){var y="";u.forEach(function(A){if(-1!==x&&(A.pageIndex===x||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===x}).length))if(""===y)y=A.mergeList&&A.mergeList.length?m(A.mergeList,x):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var G=[y].concat(A.mergeList);y=m(G,x)}y.rect.x>A.rect.x&&(y.rect.x=A.rect.x);y.rect.y>A.rect.y&&(y.rect.y=A.rect.y);y.rect.endX<A.rect.endX&&(y.rect.endX=A.rect.endX);y.rect.endY<
A.rect.endY&&(y.rect.endY=A.rect.endY);y.rect.width=y.rect.endX-y.rect.x;y.rect.height=y.rect.endY-y.rect.y}});return y}function p(u){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,u,q):q(u)}function q(u){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,u,B):B(u)}function B(u){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var x=bookConfig.periodsConfigPath;x=x.replace("%periodicalId%",window.book_visit.periodicalId);c(x,u,w)}else w(u)}
...
l.$parent==b&&(f=l.getWidth()+22,g+=l.getWidth()+22)}g+=2;h=b.children().length;Number.between(Math.floor((e-4-f)/(h-1)),10,65);var m=f=0,p=0;for(h=0;h<this.bookmarkList.count();h++)if(k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k),l.$parent==b){var q={};g>=e?(0<p&&(m=l.getWidth()>2*p/3?m+(p/2+10):m+(p-l.getWidth()/2+10)),q[c]=m,p=l.getWidth()):(q[c]=f,f+=l.getWidth()+22);q["z-index"]=d*k.pageIndex;l.setPosition(q)}},show:function(){this.visible=!0;this.refresh()},hide:function(){this.hideLeftBar();
...
onResize:function(b,c,d){this.scale=d;this.pageWidth=b;this.pageHeight=c;this.canvasPanel[0].width=b;this.canvasPanel[0].height=c;this.drawCanvas[0].width=b;this.drawCanvas[0].height=c;this.panelContainer.css({width:this.pageWidth+"px",height:this.pageHeight+"px"});this.resizeNote(b,c)},resizeNote:function(b,c){var d=this,e,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){if(1==l.nextAddress)return global.annotationCookie?l.yield(global.annotationCookie.getCookie("Note"),2):
l.return();e=l.yieldResult;if(!e)return l.return();f=e[d.index-1];if(!f)return l.return();for(g in f)h=b,k=c,d.noteParent.find("#"+g).css({left:f[g].position.x*h+"px",top:f[g].position.y*k+"px",width:f[g].size*b+"px",height:f[g].size*c+"px"}),d.noteParent.find("#"+g).find(".noteBox").css({top:f[g].size*k+10+"px"});l.jumpToEnd()})},initEvent:function(){this.eraserCircle.bind("pointerdown ",function(b){b.preventDefault()}.bind(this));this.panelContainer.bind("pointerdown mousedown mouseup mouseover mousemove",
function(b){b.stopPropagation()}.bind(this));this.panelContainer.bind("touchstart touchend touchmove",function(b){b.stopPropagation();b.preventDefault()}.bind(this));this.drawCanvas.bind("pointerdown ",function(b){b.stopPropagation()}.bind(this));this.canvasPanel.bind("pointerdown ",function(b){b.stopPropagation()}.bind(this));this.panelContainer.bind(_event._move,function(b){this.panelContainer.css({cursor:"auto"});switch(global.annotationPannel.selectCase){case AnnotationPannel.PEN:this.panelContainer.css({cursor:"url("+
uiBaseURL+"note_edit.png),auto"});break;case AnnotationPannel.RECT:this.panelContainer.css({cursor:"url("+uiBaseURL+"note_edit.png),auto"});break;case AnnotationPannel.ROUND:this.panelContainer.css({cursor:"url("+uiBaseURL+"note_edit.png),auto"})}}.bind(this));this.penPaint(this.drawCanvas);this.penPaint(this.canvasPanel)},penPaint:function(b){var c=0,d=0;b.bind(_event._down,function(e){(isPhone()||isPad())&&global.annotationPannel.bottomBox.css({display:"none"});global.colorPanel&&global.colorPanel.visible&&
global.colorPanel.curElem[0]==global.annotationPannel.showColor[0]&&global.colorPanel.hide();global.annotationCookie.currentSteps=[];2==global.annotationPannel.selectCase||3==global.annotationPannel.selectCase||4==global.annotationPannel.selectCase?(c=2,d=16):d=c=-4;if(isPhone()||isPad())d=c=0;e=this.getPosition(e,c,d);this.X=e.x;this.Y=e.y;if(5==global.annotationPannel.selectCase){var f=this.getNumberFromSlider("eraser")/2;isPhone()||isPad()||(f=0);this.X=e.x-f;this.Y=e.y-f;var g={x:(e.x-f)/this.pageWidth,
y:(e.y-f)/this.pageHeight,lineWidth:this.getNumberFromSlider("eraser")/this.pageWidth};this.showEraser(e.x-f,e.y-f,"block");this.eraserClear(e.x-f,e.y-f);global.annotationCookie.currentSteps.push(g)}this.noLeaveCvs=this.isDown=!0}.bind(this));b.bind(_event._up,function(e){this.eraserCircle.css({display:"none"});this.noLeaveCvs&&(this.drawCaseEvent(e),this.isDown=this.noLeaveCvs=!1)}.bind(this));b.bind("mouseleave",function(e){this.noLeaveCvs=!1;if(this.isDown&&this.lastPos){this.isDown=!1;switch(global.annotationPannel.selectCase){case 2:global.annotationCookie.setAllAnnoSteps(2,
this.index-1,global.annotationCookie.currentSteps);global.annotationCookie.stepIndex+=1;break;case 3:e={startX:this.X/this.pageWidth,startY:this.Y/this.pageHeight,x:this.lastPos.x/this.pageWidth,y:this.lastPos.y/this.pageHeight,lineWidth:this.getNumberFromSlider("width")/this.pageWidth,color:Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100)};global.annotationCookie.setAllAnnoSteps(3,this.index-1,[e]);global.annotationCookie.stepIndex+=1;this.drawCtx.clearRect(0,
0,this.pageWidth,this.pageHeight);this.drawRect(this.ctx,this.lastPos.x,this.lastPos.y);break;case 4:e={startX:this.X/this.pageWidth,startY:this.Y/this.pageHeight,x:this.lastPos.x/this.pageWidth,y:this.lastPos.y/this.pageHeight,lineWidth:this.getNumberFromSlider("width")/this.pageWidth,color:Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100)};global.annotationCookie.setAllAnnoSteps(4,this.index-1,[e]);global.annotationCookie.stepIndex+=1;this.drawCtx.clearRect(0,
0,this.pageWidth,this.pageHeight);this.drawEllipse(this.ctx,this.lastPos.x,this.lastPos.y);break;case 5:global.annotationCookie.setAllAnnoSteps(5,this.index-1,global.annotationCookie.currentSteps),global.annotationCookie.stepIndex+=1}this.lastPos=void 0}}.bind(this));b.bind(_event._move,function(e){if(this.isDown&&this.noLeaveCvs)switch(e=this.getPosition(e,c,d),global.annotationPannel.selectCase){case AnnotationPannel.PEN:var f={startX:this.X/this.pageWidth,startY:this.Y/this.pageHeight,x:e.x/this.pageWidth,
y:e.y/this.pageHeight,lineWidth:this.getNumberFromSlider("width")/this.pageWidth,opacity:this.getNumberFromSlider("alpha")/100,color:Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100)};global.annotationCookie.currentSteps.push(f);this.drawLine(e.x,e.y);this.noLeaveCvs&&(this.lastPos=e);break;case AnnotationPannel.ERASER:var g=this.getNumberFromSlider("eraser")/2;isPhone()||isPad()||(g=0);this.showEraser(e.x-g,e.y-g,"block");f={x:(e.x-g)/this.pageWidth,y:(e.y-
g)/this.pageHeight,lineWidth:this.getNumberFromSlider("eraser")/this.pageWidth};global.annotationCookie.currentSteps.push(f);this.eraserClear(e.x-g,e.y-g);this.noLeaveCvs&&(this.lastPos=e);break;case AnnotationPannel.RECT:this.drawCtx.clearRect(0,0,this.pageWidth,this.pageHeight);this.drawRect(this.drawCtx,e.x,e.y);this.noLeaveCvs&&(this.lastPos=e);break;case AnnotationPannel.ROUND:this.drawCtx.clearRect(0,0,this.pageWidth,this.pageHeight),this.drawEllipse(this.drawCtx,e.x,e.y),this.noLeaveCvs&&(this.lastPos=
e)}}.bind(this))},getNumberFromSlider:function(b){switch(b){case "width":return isPhone()||isPad()?parseInt(global.annotationPannel.widthBox.find(".bubbleNum").text()):global.annotationPannel.inputWidth.val();case "eraser":return isPhone()||isPad()?parseInt(global.annotationPannel.eraserBox.find(".bubbleNum").text()):global.annotationPannel.inputEraserWidth.val();case "alpha":return isPhone()||isPad()?parseInt(global.annotationPannel.alphaBox.find(".bubbleNum").text()):global.annotationPannel.inputAlpha.val()}},
drawCaseEvent:function(b){switch(global.annotationPannel.selectCase){case 2:b=this.getPosition(b,2,16);global.annotationCookie.setAllAnnoSteps(2,this.index-1,global.annotationCookie.currentSteps);this.X=b.x;this.Y=b.y;global.annotationCookie.stepIndex+=1;break;case 3:b=this.getPosition(b,2,16);var c={startX:this.X/this.pageWidth,startY:this.Y/this.pageHeight,x:b.x/this.pageWidth,y:b.y/this.pageHeight,lineWidth:this.getNumberFromSlider("width")/this.pageWidth,color:Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/
...
100)};global.annotationCookie.setAllAnnoSteps(4,this.index-1,[c]);this.drawEllipse(this.ctx,b.x,b.y);this.drawCtx.clearRect(0,0,this.pageWidth,this.pageHeight);this.X=b.x;this.Y=b.y;global.annotationCookie.stepIndex+=1;break;case 5:global.annotationCookie.setAllAnnoSteps(5,this.index-1,global.annotationCookie.currentSteps),global.annotationCookie.stepIndex+=1}},getPosition:function(b,c,d,e){if(isPad()||isPhone())d=c=0,"note"==e&&(c=-this.pageWidth/25,d=-this.pageHeight/28);e=BookInfo.getBook().showPage.parameters.toScale||
1;b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:b.changedTouches?b.changedTouches:[b];var f=document.documentElement.scrollLeft||document.body.scrollLeft,g=document.documentElement.scrollTop||document.body.scrollTop;c=(b[0].pageX||b[0].clientX+f)-this.panelContainer.offset().left+c;b=(b[0].pageY||b[0].clientY+g)-this.panelContainer.offset().top+d;return{x:c/e,y:b/e}},showEraser:function(b,c){var d=this.getNumberFromSlider("eraser");this.eraserCircle.css({"pointer-events":"none",
display:"block",background:"rgba(33,33,33,0.4)",width:d+"px",height:d+"px",left:b+"px",top:c+"px"})},drawLine:function(b,c){this.ctx.beginPath();.85<=this.getNumberFromSlider("alpha")/100?this.ctx.lineCap="round":this.ctx.lineCap="butt";this.ctx.lineJoin="round";this.ctx.lineWidth=this.getNumberFromSlider("width");this.ctx.strokeStyle=Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100);this.ctx.moveTo(this.X,this.Y);this.ctx.lineTo(b,c);this.ctx.stroke();this.X=
b;this.Y=c},drawRect:function(b,c,d){b.beginPath();b.lineCap="round";b.lineJoin="round";b.lineWidth=this.getNumberFromSlider("width");b.strokeStyle=Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100);var e=this.X,f=this.Y;0>c-this.X&&(e=c);0>d-this.Y&&(f=d);b.moveTo(e,f);b.strokeRect(e,f,Math.abs(c-this.X),Math.abs(d-this.Y));b.stroke()},drawEllipse:function(b,c,d){c=c/2+this.X/2;d=d/2+this.Y/2;var e=Math.abs(c-this.X),f=Math.abs(d-this.Y);b.lineCap="round";
b.lineJoin="round";b.lineWidth=this.getNumberFromSlider("width");b.strokeStyle=Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100);b.save();var g=e>f?e:f;e/=g;f/=g;b.scale(e,f);b.beginPath();b.arc(c/e,d/f,g,0,2*Math.PI,!1);b.closePath();b.restore();b.stroke()},eraserClear:function(b,c){this.ctx.beginPath();this.ctx.stroke();this.ctx.clearRect(this.X,this.Y,this.getNumberFromSlider("eraser"),this.getNumberFromSlider("eraser"));this.X=b;this.Y=c},clearCvs:function(){this.ctx.clearRect(0,
0,this.pageWidth,this.pageHeight)}});
AnnotationCookie=Class({create:function(b,c,d){var e=this;this.parent=b;this.bookType=BookInfo.getBookType();this.pageWidth=c;this.pageHeight=d;this.defaultWidth=c;this.scale=this.tranScale=1;this.stepIndex=0;this.currentSteps=[];this.allAnnoSteps=[];this.migrationStatusMap=new Map;global.annotationCookieDB=new AnnotationCookieDB;global.annotationCookieDB.init().then(function(){e.migrateData()})},getCookieName:function(b){var c=bookConfig.ClientBookId?bookConfig.ClientBookId:"";return window.location.href.replace(window.location.hash,
"").replace(window.location.search,"")+c+b},getCookie:function(b){var c=this,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){return 1==f.nextAddress?(null==(d=c.migrationStatusMap.get(b))?0:d.isDone)?f.jumpTo(2):f.yield(c.migrateLocalStorageToIndexedDB(b),2):4!=f.nextAddress?f.yield(global.annotationCookieDB.getCookie(b),4):(e=f.yieldResult)?f.return(e):f.return(null)})},migrateData:function(){var b=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){return 1==c.nextAddress?
c.yield(b.migrateLocalStorageToIndexedDB("Cookie"),2):c.yield(b.migrateLocalStorageToIndexedDB("Note"),0)})},migrateLocalStorageToIndexedDB:function(b){var c=this,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:d=c.migrationStatusMap.get(b)||{promise:null,isDone:!1};if(d.isDone)return f.return();if(!d.promise){f.jumpTo(2);break}return f.yield(d.promise,3);case 3:return f.return();case 2:return e=function(){var g,h,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return p.yield(global.annotationCookieDB.getCookie(b),
2);case 2:if(g=p.yieldResult)return p.return(g);h=c.getCookieName(b);k=window.localStorage.getItem(h);if(!k)return p.return();m=l=JSON.parse(k);p.setCatchFinallyBlocks(3);return p.yield(global.annotationCookieDB.saveCookie(b,m),5);case 5:p.leaveTryBlock(0);break;case 3:p.enterCatchBlock(),p.jumpToEnd()}})}.call(c),c.migrationStatusMap.set(b,{promise:e,isDone:!1}),f.yield(e,4);case 4:c.migrationStatusMap.set(b,{promise:null,isDone:!0}),f.jumpToEnd()}})},hasCvsCookie:function(b){var c=this,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:d=
["Cookie"],e=0;case 2:if(!(e<d.length)){g.jumpTo(4);break}return g.yield(c.getCookie(d[e]),5);case 5:if((f=g.yieldResult)&&f.length&&f[b]&&f[b].length)return g.return(!0);e++;g.jumpTo(2);break;case 4:return g.return(!1)}})},saveCookie:function(){var b=this,c,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return g.yield(b.getCookie("Cookie",!1),2);(c=g.yieldResult)||(c=[]);for(d=0;d<b.stepIndex;d++)if(e=b.allAnnoSteps[d].index,b.isArray(e))for(f=0;f<e.length;f++)c[e[f]]=
[];else c[e]||(c[e]=[]),c[e].push(b.allAnnoSteps[d]);return g.yield(global.annotationCookieDB.saveCookie("Cookie",c),0)})},getPage:function(b){b=b?b+1:BookInfo.getBook().currentPageIndex;var c="";"slide"==bookConfig.FlipStyle.toLocaleLowerCase()&&BookInfo.isDoublePage(BookInfo.getBookType())?(BookInfo.getBook().pageArray[b].leftPage?c=BookInfo.getBook().pageArray[b].leftPage.pageAttachments.$animation:BookInfo.getBook().pageArray[b].rightPage&&(c=BookInfo.getBook().pageArray[b].rightPage.pageAttachments.$animation),
rightToLeft&&BookInfo.getBook().pageArray[b].rightPage&&(c=BookInfo.getBook().pageArray[b].rightPage.pageAttachments.$animation)):c=BookInfo.getBook().pageArray[b].page.pageAttachments.$animation;return c},repaintCookie:function(b,c,d,e){var f=this,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){f.pageWidth=b;f.pageHeight=c;e||(e=f.getPage(d));b&&c||(f.pageWidth=e.width(),f.pageHeight=e.height());if(!f.pageWidth||!f.pageHeight)return l.return();f.clearUnsaveCookie();if(!BookInfo.getBook().showPage.find("#annotationCvsPanel"+
(d+1))[0])return l.return();g=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(d+1))[0].getContext("2d");g.clearRect(0,0,f.pageWidth,f.pageHeight);h=function(){f.getCookie("Cookie").then(function(m){m&&m[d]&&f.putCookie(d,m[d])})};k=function(){f.getCookie("Note").then(function(m){if(e&&m){m[d]&&Object.keys(m[d]).length&&e.css({display:"block"});for(var p in m[d]){var q=m[d][p],B=q.position.x*f.pageWidth,w=q.position.y*f.pageHeight,v=e.find("#"+p),u=f.getNoteBoxSize();v[0]?(v.css({"font-size":14/
f.scale+"px",left:B/f.scale+"px",top:w/f.scale+"px",width:.05*f.pageWidth/f.scale+"px",height:.05*f.pageWidth/f.scale+"px"}),isPad()||isPhone()?(v.css({width:.05*f.pageWidth/f.scale+"px",height:.05*f.pageWidth/f.scale+"px"}),v.find(".noteBox").css({top:"50%",left:"50%",transform:"translate(-50%, -50%)","-webkit-transform":"translate(-50%, -50%)"})):v.find(".noteBox").css({top:(.05*f.pageWidth+10)/f.scale+"px","-webkit-transform":"scale("+f.tranScale+")","-o-transform":"scale("+f.tranScale+")","-moz-transform":"scale("+
f.tranScale+")","-ms-transform":"scale("+f.tranScale+")",transform:"scale("+f.tranScale+")","-webkit-transform-origin":"0 0","-o-transform-origin":"0 0","-moz-transform-origin":"0 0","-ms-transform-origin":"0 0","transform-origin":"0 0"}),v.find(".noteBox textarea").css({width:u.width-20+"px",height:u.height+"px"}).val(q.value),isPhone()||isPad()?v.find(".noteBox .noteTitle").css({width:u.width-82+"px"}):v.find(".noteBox .noteTitle").css({width:u.width-68+"px"}),f.refreshNoteColor(v,q.colorIndex,
u)):isPhone()||isPad()?new AnnotationAddMobileNote(e,m[d][p]):new AnnotationAddNote(e,m[d][p])}}})};h();k();l.jumpToEnd()})},getNoteBoxSize:function(){if(isPhone()){var b=148<parseInt(this.pageWidth/2)?148:parseInt(this.pageWidth/2);var c=80<parseInt(this.pageHeight/2)?80:parseInt(this.pageHeight/2)}else b=228<parseInt(this.pageWidth/2)?228:parseInt(this.pageWidth/2),c=100<parseInt(this.pageHeight/2)?100:parseInt(this.pageHeight/2);c>b-20&&(c=b-20);return{width:b,height:c}},refreshNoteColor:function(b,
c,d){if(void 0!=c){var e=b.find(".noteBox"),f="#FFF1dc #ffe2df #e6f6ff #e7ffea #f3e9ff #d0cdc7".split(" "),g=e.find(".colorBox");b.find(".noteSvgIcon").html(this.getNoteSvg(f[c]));e.css({background:f[c]});b=$(g.find("span")[c]);if(isPhone()||isPad())4>h&&(h=4),8<h&&(h=8),g.find("span").removeClass("active").css({margin:"10px "+h+"px;"});else{var h=(d.width-72)/7;4>h&&(h=4);g.find("span").removeClass("active").css({margin:"9px 0 9px "+h+"px","box-shadow":"0 0 0 1px rgba(11,11,11,0.3)","-webkit-box-shadow":"0 0 0 1px rgba(11,11,11,0.3)"})}b.addClass("active").css({"box-shadow":"0 0 0 2px #4BA0FF",
"-webkit-box-shadow":"0 0 0 2px #4BA0FF"})}},getNoteSvg:function(b){return'<svg style="position:absolute;top:0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><defs><style>.cls-1, .cls-2 {fill-rule: evenodd;}.cls-1 {opacity: 0.85;}</style></defs><path id="\u8930\u3222\u59f8_2" data-name="\u8930\u3222\u59f8 2" class="cls-1" d="M2,0H15.917A1.98,1.98,0,0,1,18,2V13l-5,5s-8.875.063-11,0-2-2.667-2-2.667-0.062-10.562,0-13S2,0,2,0Z"/><path  fill="'+b+'" id="\u8930\u3222\u59f8_2_\u93b7\u75af\u7909" data-name="\u8930\u3222\u59f8 2 \u93b7\u75af\u7909" class="cls-2" d="M2,1H16a0.863,0.863,0,0,1,1,1c-0.031,1.156,0,10,0,10H12v5H2s-0.906.281-1-1S0.969,3,1,2A0.994,0.994,0,0,1,2,1ZM13,13h4l-4,4V13ZM4.5,5h5a0.5,0.5,0,0,1,0,1h-5A0.5,0.5,0,0,1,4.5,5Zm0,3h7a0.5,0.5,0,0,1,0,1h-7A0.5,0.5,0,0,1,4.5,8Zm0,3h5a0.5,0.5,0,0,1,0,1h-5A0.5,0.5,0,0,1,4.5,11Z"/></svg>'},
putCookie:function(b,c){if(BookInfo.getBook().showPage.find("#annotationCvsPanel"+(b+1))[0]&&(BookInfo.getBook().showPage.find("#annotationCvsPanel"+(b+1))[0].getContext("2d"),c))for(var d=0;d<c.length;d++){var e=c[d].cookie,f=c[d].type;var g=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(b+1))[0].getContext("2d");if("Clear"==f)for(var h=BookInfo.getCurrentPages(),k=0;k<h.length;k++){g=BookInfo.getBook().showPage.find("#annotationCvsPanel"+h[k])[0];if(!g)return;g=g.getContext("2d");g.clearRect(0,
0,this.pageWidth,this.pageHeight)}for(h=0;h<e.length;h++)switch(f){case "Pen":this.drawLine(g,e[h]);break;case "Rect":this.drawRect(g,e[h]);break;case "Round":this.drawRound(g,e[h]);break;case "Eraser":this.drawClear(g,e[h])}}},stepPaint:function(b,c,d){if("Clear"!=b)var e=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(c+1))[0].getContext("2d");for(var f=0;f<d.length;f++)switch(b){case "Pen":this.drawLine(e,d[f]);break;case "Rect":this.drawRect(e,d[f]);break;case "Round":this.drawRound(e,
d[f]);break;case "Eraser":this.drawClear(e,d[f]);break;case "Clear":for(var g=0;g<c.length;g++)e=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(c[g]+1))[0].getContext("2d"),e.clearRect(0,0,this.pageWidth,this.pageHeight)}},repaintSteps:function(){var b=this,c,d,e,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:if(!b.allAnnoSteps.length)return l.return();l.setCatchFinallyBlocks(2);c=BookInfo.getCurrentPages();d=0;case 4:if(!(d<c.length)){for(h=
0;h<b.stepIndex;h++)b.stepPaint(b.allAnnoSteps[h].type,b.allAnnoSteps[h].index,b.allAnnoSteps[h].cookie);l.leaveTryBlock(0);break}e=BookInfo.getBook().showPage.find("#annotationCvsPanel"+c[d])[0].getContext("2d");e.clearRect(0,0,b.pageWidth,b.pageHeight);return l.yield(b.hasCvsCookie(c[d]-1),7);case 7:f=l.yieldResult;if(!f){l.jumpTo(5);break}return l.yield(b.getCookie("Cookie"),9);case 9:g=l.yieldResult,b.putCookie(c[d]-1,g[c[d]-1]);case 5:d++;l.jumpTo(4);break;case 2:k=l.enterCatchBlock(),console.log(k),
l.jumpToEnd()}})},clearUnsaveCookie:function(){this.stepIndex=0;this.currentSteps=[];this.allAnnoSteps=[]},deleteNoteCookie:function(b,c,d){return global.annotationCookieDB.deleteNoteCookie(b,c,d)},isArray:function(b){return"[object Array]"==Object.prototype.toString.call(b)},drawRound:function(b,c){if(this.isFullConfig(c)){var d=(c.x/2+c.startX/2)*this.pageWidth,e=(c.y/2+c.startY/2)*this.pageHeight,f=Math.abs(d-c.startX*this.pageWidth),g=Math.abs(e-c.startY*this.pageHeight);b.lineCap="round";b.lineJoin=
"round";b.lineWidth=parseInt(c.lineWidth*this.pageWidth);b.strokeStyle=c.color;b.save();c=f>g?f:g;f/=c;g/=c;b.scale(f,g);b.beginPath();b.arc(d/f,e/g,c,0,2*Math.PI,!1);b.closePath();b.restore();b.stroke()}},drawRect:function(b,c){if(this.isFullConfig(c)){b.beginPath();b.lineCap="round";b.lineJoin="round";b.lineWidth=c.lineWidth*this.pageWidth;b.strokeStyle=c.color;var d=c.startX*this.pageWidth,e=c.startY*this.pageHeight;0>c.x-c.startX&&(d=c.x*this.pageWidth);0>c.y-c.startY&&(e=c.y*this.pageHeight);
b.moveTo(d,e);b.strokeRect(d,e,Math.abs(c.x-c.startX)*this.pageWidth,Math.abs(c.y-c.startY)*this.pageHeight);b.stroke()}},drawLine:function(b,c){this.isFullConfig(c)&&(b.lineCap=.85<=c.opacity?"round":"butt",b.lineJoin="round",b.lineWidth=c.lineWidth*this.pageWidth,b.strokeStyle=c.color,b.beginPath(),b.moveTo(c.startX*this.pageWidth,c.startY*this.pageHeight),b.lineTo(c.x*this.pageWidth,c.y*this.pageHeight),b.stroke(),b.closePath())},drawClear:function(b,c){b&&c.x&&c.y&&c.lineWidth&&(b.beginPath(),
b.clearRect(c.x*this.pageWidth,c.y*this.pageHeight,c.lineWidth*this.pageWidth,c.lineWidth*this.pageWidth),b.stroke(),b.closePath())},isFullConfig:function(b){return b&&b.startX&&b.startY&&b.x&&b.y&&b.lineWidth&&b.color},onResize:function(b,c,d){this.scale=d;this.tranScale=b/this.defaultWidth;this.pageWidth=b;this.pageHeight=c},setAllAnnoSteps:function(b,c,d){this.allAnnoSteps.length>this.stepIndex&&(this.allAnnoSteps.length=this.stepIndex);switch(b){case 2:this.allAnnoSteps.push({type:"Pen",index:c,
cookie:d});break;case 3:this.allAnnoSteps.push({type:"Rect",index:c,cookie:d});break;case 4:this.allAnnoSteps.push({type:"Round",index:c,cookie:d});break;case 5:this.allAnnoSteps.push({type:"Eraser",index:c,cookie:d});break;case 11:this.allAnnoSteps.push({type:"Clear",index:c,cookie:d})}},saveNoteCookie:function(b,c,d,e){return global.annotationCookieDB.saveNoteCookie(b,c,d,e)}});
var AnnotationCookieDB=Class({create:function(){this.annotationDb=null;this.storeName="annotations";this.initPromise=null;this.isInitialized=!1},init:function(b){b=void 0===b?"AnnotationDB":b;var c=this,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:if(c.isInitialized)return k.return();d=0;e=5;case 2:if(!("undefined"===typeof Dexie&&d<e)){if("undefined"===typeof Dexie)return k.return();k.setCatchFinallyBlocks(5);c.annotationDb=new Dexie(b);f=
{};c.annotationDb.version(1).stores((f[c.storeName]="++id, key, type",f));c.initPromise=c.annotationDb.open();return k.yield(c.initPromise,7)}return k.yield(new Promise(function(l){return setTimeout(l,100)}),4);case 4:d++;k.jumpTo(2);break;case 7:c.isInitialized=!0;k.leaveTryBlock(0);break;case 5:return k.enterCatchBlock(),k.setCatchFinallyBlocks(8),k.yield(null==(g=c.annotationDb)?void 0:g.delete(),10);case 10:return c.annotationDb=new Dexie(b),h={},c.annotationDb.version(1).stores((h[c.storeName]=
"++id, key, type",h)),c.initPromise=c.annotationDb.open(),k.yield(c.initPromise,11);case 11:c.isInitialized=!0;k.leaveTryBlock(0);break;case 8:k.enterCatchBlock(),k.jumpToEnd()}})},ensureInit:function(){var b=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){switch(c.nextAddress){case 1:if(b.isInitialized){c.jumpTo(2);break}return c.yield(b.init(),2);case 2:return c.setCatchFinallyBlocks(4),c.yield(b.initPromise,6);case 6:c.leaveTryBlock(0);break;case 4:c.enterCatchBlock(),c.jumpToEnd()}})},
getCookieName:function(b){var c="undefined"!==typeof bookConfig&&bookConfig.ClientBookId?bookConfig.ClientBookId:"";return window.location.href.replace(window.location.hash,"").replace(window.location.search,"")+c+b},getCookie:function(b){var c=this,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(c.ensureInit(),2);case 2:return d=c.getCookieName(b),g.setCatchFinallyBlocks(3),g.yield(c.annotationDb[c.storeName].where("key").equals(d).first(),
5);case 5:return(e=g.yieldResult)&&e.content?g.return(JSON.parse(e.content)):g.return(null);case 3:return f=g.enterCatchBlock(),console.log("getCookie error:",f),g.return(null)}})},saveCookie:function(b,c,d){d=void 0===d?"":d;var e=this,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(e.ensureInit(),2);case 2:return f=e.getCookieName(b),g={key:f,type:d,content:"string"===typeof c?c:JSON.stringify(c)},l.setCatchFinallyBlocks(3),l.yield(e.annotationDb[e.storeName].where("key").equals(f).first(),
5);case 5:return(h=l.yieldResult)?(g.id=h.id,l.yield(e.annotationDb[e.storeName].put(g),9)):l.yield(e.annotationDb[e.storeName].add(g),8);case 8:return l.return(l.yieldResult);case 9:return l.return(l.yieldResult);case 7:l.leaveTryBlock(0);break;case 3:k=l.enterCatchBlock(),console.log("saveCookie error:",k),l.jumpToEnd()}})},deleteCookie:function(b){var c=this,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.yield(c.ensureInit(),2);case 2:return d=
c.getCookieName(b),f.setCatchFinallyBlocks(3),f.yield(c.annotationDb[c.storeName].where("key").equals(d).delete(),5);case 5:return f.return(f.yieldResult);case 3:e=f.enterCatchBlock(),console.log("deleteCookie error:",e),f.jumpToEnd()}})},saveNoteCookie:function(b,c,d,e){var f=this,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(f.ensureInit(),2);case 2:return h.yield(f.getCookie(b),3);case 3:return g=(g=h.yieldResult)||[],g[c]||(g[c]={}),
g[c][d]=e,h.yield(f.saveCookie(b,g),4);case 4:return h.return(h.yieldResult)}})},deleteNoteCookie:function(b,c,d){var e=this,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.yield(e.ensureInit(),2);case 2:return g.yield(e.getCookie(b),3);case 3:f=g.yieldResult;if(!(f&&f[c]&&f[c][d])){console.log("Note item not found");g.jumpTo(0);break}delete f[c][d];0===Object.keys(f[c]).length&&(f[c]=null);return g.yield(e.saveCookie(b,f),5);case 5:return g.return(g.yieldResult)}})}}),
GrayShadow=Class({create:function(b){this.grayShadow=$("<div class='grayShadow'></div>");var c=$("<div class='kong edgeShadow' ></div>");this.grayShadow.append(c);b.append(this.grayShadow)},show:function(){this.grayShadow.show()},hide:function(){this.grayShadow.hide()},onResize:function(){}}),PageHighlightsFlipShadow=Class({create:function(b,c){this.parent=b;this.pageIndex=c;this.init()},init:function(){bookConfig.FlipDirection?(this.flipBackShadow=$("<div class='flip-vertical-shadowB'></div>"),this.flipFrontShadow=
$("<div class='flip-vertical-topshadow2'></div>"),this.flipFrontHighlightShadow=$("<div class='flip-vertical-top-hightlight-shadow'></div>"),this.flipFrontEdgeShadow=$("<div class='flip-vertical-top-edge-shadow'></div>"),this.flipFrontTopHighlightShadow=$("<div class='flip-vertical-front-top-hightlight-shadow'></div>")):(this.flipBackShadow=$("<div class='flip-shadowB2'></div>"),this.flipFrontShadow=$("<div class='flip-topshadow2'></div>"),this.flipFrontHighlightShadow=$("<div class='flip-top-hightlight-shadow'></div>"),
...
c==totalPageCount;this.isInnerCover=2==c&&!bookConfig.isTheBookOpen||1==c&&bookConfig.isTheBookOpen||c==totalPageCount-1;this.isCover=this.isOutCover||this.isInnerCover}}).extend("PageTexture"),SlidePageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isCover=!1}}).extend("PageTexture"),DocViewPageTexture=Class({create:function(b,c,d){this._super(b,c,d);this.isCover=!1}}).extend("PageTexture"),BorderSewing={deep:{top:{url:"deep_top_sewing.png",width:28,height:42},left:{url:"deep_left_sewing.png",
width:71,height:28},right:{url:"deep_right_sewing.png",width:71,height:28},bottom:{url:"deep_bottom_sewing.png",width:28,height:42},renderBorder:!0},normal:{top:{url:"normal_top_sewing.png",width:28,height:10},left:{url:"normal_left_sewing.png",width:10,height:28},right:{url:"normal_right_sewing.png",width:10,height:28},bottom:{url:"normal_bottom_sewing.png",width:28,height:20},renderBorder:!0},flat:{top:{url:"flat_top_sewing.png",width:28,height:10},left:{url:"flat_left_sewing.png",width:10,height:28},
right:{url:"flat_right_sewing.png",width:10,height:28},bottom:{url:"flat_bottom_sewing.png",width:28,height:10},renderBorder:!1}},PageTextureResource={leather1:{texture:"leather1.png",sewing:BorderSewing.deep},leather2:{texture:"leather2.png",sewing:BorderSewing.normal},cloth1:{texture:"cloth1.png",sewing:BorderSewing.flat},cloth2:{texture:"cloth2.png",sewing:BorderSewing.flat},cloth3:{texture:"cloth3.png",sewing:BorderSewing.flat},cloth4:{texture:"cloth4.png",sewing:BorderSewing.normal},cardboard1:{texture:"cardboard1.png",
sewing:null},cardboard2:{texture:"cardboard2.png",sewing:null},cardboard3:{texture:"cardboard3.png",sewing:null},silk1:{texture:"silk1.png",sewing:BorderSewing.flat},silk2:{texture:"silk2.png",sewing:BorderSewing.flat},silk3:{texture:"silk3.png",sewing:BorderSewing.flat},silk4:{texture:"silk4.png",sewing:BorderSewing.flat},wood1:{texture:"wood1.png",sewing:null},wood2:{texture:"wood2.png",sewing:null}},PageRendering=Class({create:function(b,c,d){this.parent=b;this.pageIndex=c;this.isLeftPage=getPageDirection(c,
d);this.pageShadow=getPageShadow(b,c,this.isLeftPage,d);this.pageTexture=getPageTexture(b,c,this.isLeftPage,d);this.grayshadow=getGrayShadow(b,c,this.isLeftPage,d)},render:function(){this.addCoil();this.addPageShadow();this.addPageTexture()},addCoil:function(){if("loose2"==bookConfig.BindingType)this.addCoil2();else if(parseBool(bookConfig.addPaperCoil)){var b=$("<div class='coil'></div>");this.midCoil=$("<div style='z-index:6;'></div>");bookConfig.FlipDirection?this.isLeftPage?(b.attr("class","upPaperCoil"),
this.midCoil.attr("class","upPaperCoil_bg")):(b.attr("class","downPaperCoil"),this.midCoil.attr("class","downPaperCoil_bg")):this.isLeftPage?(b.attr("class","leftPaperCoil"),this.midCoil.attr("class","leftPaperCoil_bg")):(b.attr("class","rightPaperCoil"),this.midCoil.attr("class","rightPaperCoil_bg"));this.midCoil.append(b);!bookConfig.HardPageEnable||1!=this.pageIndex&&this.pageIndex!=totalPageCount||this.midCoil.css("background-image","none");this.parent.append(this.midCoil)}},addCoil2:function(){if(parseBool(bookConfig.addPaperCoil)){var b=
...
f=d;"string"==typeof d&&(f=[d]);if(f&&0!=f.length){var g=[];for(d=0;d<f.length;d++){var h=toAbsURL(f[d])+(window.isSupportWebp?"":"?x-oss-process=image/format,jpg");g.push(h)}d=BookRestrict.getRestrictToken();$.ajax({type:"get",url:restrictUrl,dataType:"json",data:{urls:JSON.stringify(g),token:d},success:function(k){if("OK"==k.code){for(var l=!0,m=0;m<f.length;m++){var p=g[m];accessControlImagesPool[f[m]]=k.data[p];k.data[p]||(l=!1)}e.completedTask(b,c);l&&e.completedAllTask(b,c)}else window.encryptionPannel&&
...
"previewPage",b);if("string"!=typeof d)for(var h=0;h<d.length;h++)d[h]=resetFliphtml5URL(d[h]);else d=resetFliphtml5URL(d);e=resetFliphtml5URL(e);f=resetFliphtml5URL(f);g=resetFliphtml5URL(g);adjustPageURL(c,0,e);adjustPageURL(c,1,d);adjustPageURL(c,2,f);adjustPageURL(c,3,g)}},useTheAliCloudChart=function(b,c){if(bookConfig.useTheAliCloudChart){if(isPad()||isPhone())try{b*=devicePixelRatio,c*=devicePixelRatio}catch(m){}for(var d=bookConfig.totalPageCount,e=1;e<=d;e++){var f=realPageDir(e,"normal",
d),g=realPageDir(e,"large",d),h=realPageDir(e,"thumb",d),k=realPageDir(e,"previewPage",d);if("string"!=typeof f)for(var l=0;l<f.length;l++)f[l]=resetYunzhanURL(f[l],b,c);else f=resetYunzhanURL(f,b,c);g=resetYunzhanURL(g);h=resetYunzhanURL(h);k=resetYunzhanURL(k);adjustPageURL(e,0,g);adjustPageURL(e,1,f);adjustPageURL(e,2,h);adjustPageURL(e,3,k)}}},useTheAliCloudChartOnIsuuBook=function(b,c){if(bookConfig.useTheAliCloudChart&&"issuu"==bookConfig.FlipStyle)for(var d=bookConfig.totalPageCount,e=1;e<=
d;e++){var f=realPageDir(e,"normal",d),g=realPageDir(e,"large",d),h=realPageDir(e,"thumb",d),k=realPageDir(e,"previewPage",d);c=BookInfo.getBook().getPagesFitWHByIndex(e);b=c.x;c=c.y;if(isPad()||isPhone())try{b*=devicePixelRatio,c*=devicePixelRatio}catch(m){}if("string"!=typeof f)for(var l=0;l<f.length;l++)f[l]=resetYunzhanURL(f[l],b,c);else f=resetYunzhanURL(f,b,c);g=resetYunzhanURL(g);h=resetYunzhanURL(h);k=resetYunzhanURL(k);adjustPageURL(e,0,g);adjustPageURL(e,1,f);adjustPageURL(e,2,h);adjustPageURL(e,
3,k)}};
...
B=0;B<canvasData[b].resources.length;B++)if(1!=canvasData[b].resources[B].type)q++,q>=canvasData[b].resources.length&&k();else{var w=new Image;w.src=getResource(b,B);globalImages[b][B]=w;w.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(w){bookConfig.largePageWidth/bookConfig.largePageHeight>w[0].naturalWidth/w[0].naturalHeight?w.css({width:"auto",height:"100%"}):w.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)p=c[m],p=p.removeStartFrom("?"),q=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),q.attr("src",p),k.append(q),q[0].onload=function(w){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},q[0].onerror=function(w){h++;h==c.length&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),q.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),q.return();p=h;loadJavascript(k,function(B){var w=dataBase64Str(b,c,B);p.$image=$("<img src='"+
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),p=b.getContext("2d"),q=p.getImageData(0,0,f,g),B=p.createImageData(c,d);q=q.data;for(var w=B.data,v=0;v<d;v++)for(var u=0;u<c;u++){for(var x=4*(u+v*c),y,A=0,G=0,F=0,O=0,L=0,H=0,I=(v+.5)*k,K=Math.ceil((v+1)*k),M=Math.floor(v*k);M<K;M++){var W=Math.abs(I-(M+.5))/m,Z=(u+.5)*h;W*=W;for(var aa=Math.ceil((u+1)*h),T=Math.floor(u*h);T<aa;T++)if(y=Math.abs(Z-(T+.5))/l,y=
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*q[U+3];G+=y;255>q[U+3]&&(y=y*q[U+3]/250);F+=y*q[U];O+=y*q[U+1];L+=y*q[U+2];A+=y}}w[x]=F/A;w[x+1]=O/A;w[x+2]=L/A;w[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
"object"==typeof g&&(g=g[0]);getBlob(g).then(function(k){this.loadingTask=pdfjsLib.getDocument({url:k.url,password:k.password});this.loadingTask.promise.then(function(l){l.getPage(1).then(function(m){this.loaded=!0;this.page=m;this.renderCanvas(this.pageWidth,this.pageHeight).then(function(p){this.rendered=!0;this.callback&&this.callback(p);d(p)}.bind(this))}.bind(this))}.bind(this))}.bind(f));h.jumpToEnd()})}.bind(this))},renderCanvas:function(b,c){this.rendered=!1;return new Promise(function(d,
e){this.renderWidth=b;this.renderHeight=c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d"),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var m=l.width,p=l.height;isPC()||(m>p?3E3<m*h&&(h=3E3/m):3E3<p*h&&(h=3E3/p));f.width=m*h;f.height=p*h;1==h?(f.style.width=f.width+"px",f.style.height=f.height+"px"):(f.style.width=m+"px",f.style.height=
...
var PdfLoad=Class({index:0,pageWidth:0,pageHeight:0,create:function(b,c,d,e,f,g,h){var k=this,l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return k.index=b,k.type=c,k.pageWidth=e,k.pageHeight=f,k.renderWidth=e,k.renderHeight=f,k.callback=d,k.parent=h,l=k,m.yield(getPageDir(b,c,originTotalPageCount),2);l.imageURL=m.yieldResult;k.$content=$("<div style='position:absolute;left:0;top:0;width:100%;height:100%;'></div>");k.pdfLoadingTask=new PdfLoadingTask(k.index,
k.type,e,f,k.loaded.bind(k));window.pdfLoadStack||(window.pdfLoadStack=new PdfLoadArray(3));window.pdfLoadStack&&pdfLoadStack.push(k.pdfLoadingTask);m.jumpToEnd()})},loaded:function(b){this.pdfLoaded=!0;this.changeImageSrc(b)},enterSide:function(){this.enter=!0},leaveSide:function(){this.enter=!1;this.pdfLoadingTask&&this.pdfLoadingTask.leaveSide()},zoomIn:function(){isPhone()||isPad()},zoomOut:function(){isPhone()||isPad()},resizeSvg:function(b,c){this.renderWidth=b;this.renderHeight=c;this.resizeImage(b,
...
this.callback&&this.callback(this.imageURL,this.imageURL,this.$content,this.index)}},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){m.index=b;m.type=d;m.i=
l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=p;m.imageObject=new ImageObject;m.imageObject.alt(m.index);m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&
this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));B.jumpToEnd()})},
...
c,d,e,f,g){var h=this,k,l,m,p,q,B;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){if(1==w.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],w.yield(getPageDir(b,c,originTotalPageCount),2);k=w.yieldResult;h.imagesURL=k;l=0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(v){l++;this.$images.removeElement(v);this.callback&&l==k.length&&this.callback(k,
k,this.$images,this.index)}.bind(h);for(q=0;q<k.length;q++)B=-1<k[q].indexOf(".svg")?new ImageArrayLoadSvg(b,k[q],c,m,p,e,f,g,q):new ImageArrayLoadImage(b,k[q],c,m,p,e,f,g,q),h.$images.push(B.$image),h.loadArray.push(B);w.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&this.loadArray[c].zoomIn(b)},zoomOut:function(b,c){for(var d=0;d<this.loadArray.length;d++)this.loadArray[d].zoomOut&&this.loadArray[d].zoomOut(b,c)},onResize:function(b,c){this.pageWidth=
...
bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.sideImage.empty().append(d);else{e.sideImage.empty();for(f=0;f<d.length;f++)isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),e.sideImage.append(d[f]);e.imageWidth=d[0][0].naturalWidth;e.imageHeight=d[0][0].naturalHeight}g=fitPageWidthHeight(e.pageWidth,e.pageHeight,e.imageWidth,e.imageHeight);!bookConfig.isSingleBookFullWindowOnMobile||
1!=e.bookType||!isPhone()&&!isPad()||e.imageWidth||e.imageHeight||(g=fitPageWidthHeight(e.pageWidth,e.pageHeight,bookConfig.largePageWidth,bookConfig.largePageHeight),h=bookConfig.largePageWidth/bookConfig.largePageHeight,k=e.pageWidth/e.pageHeight,.01>h-k&&-.01<h-k&&(g.x=e.pageWidth,g.y=e.pageHeight),e.imageWidth=g.x,e.imageHeight=g.y);e.pageAttachments||(e.pageAttachments=new PageAttachmentsParser(e.sideContent,e.imageWidth?e.imageWidth:e.pageWidth,e.imageHeight?e.imageHeight:e.pageHeight,e.pageWidth,
e.pageHeight,e.pageIndex,e.bookType,e,function(){if(this.onPageLoaded)this.onPageLoaded(this.pageIndex)}.bind(e)));l.jumpToEnd()})},isReaderConfigLoaded:function(b){var c=this,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:g.setCatchFinallyBlocks(2);d=function(){try{var h=window.setInterval(function(){window.readerConfigLoaded&&(window.clearInterval(h),b&&b())},100)}catch(k){}};window.htmlConfig&&htmlConfig.pages_editor&&(window.readerConfig=htmlConfig.pages_editor,
initReaderPopDom());if(!(window.readerConfigLoaded&&window.readerConfig&&window.readerConfig.pages&&window.readerConfig.pages[c.pageIndex-1]&&"string"==typeof window.readerConfig.pages[c.pageIndex-1])){g.jumpTo(4);break}return g.yield(getArticleImage(fixURLValue(window.readerConfig.pages[c.pageIndex-1])),5);case 5:return e=g.yieldResult,g.yield(c.loadJsonFile(e),6);case 6:return f=g.yieldResult,window.readerConfig.pages[c.pageIndex-1]=f,d(),g.return();case 4:d();g.leaveTryBlock(0);break;case 2:g.enterCatchBlock(),
g.jumpToEnd()}})},loadJsonFile:function(b){var c=this,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:return g.setCatchFinallyBlocks(2),g.yield(fetch(b),4);case 4:d=g.yieldResult;if(!d.ok)throw Error("HTTP error! status: "+d.status);return g.yield(d.json(),5);case 5:return e=g.yieldResult,"string"==typeof e&&(e=c.decodePage(e)),g.return(e);case 2:f=g.enterCatchBlock(),console.error("Error loading JSON file:",f),g.jumpToEnd()}})},decodePage:function(b){if(!b)return null;
try{var c=this.decrypt(b);return JSON.parse(c)}catch(d){return console.error("\u6924\u7538\u6f70\u7459\uff45\u7611\u6fb6\u8fab\u89e6:",d),null}},decrypt:function(b){if(!b)return"";try{var c=atob(b);b="";for(var d=0;d<c.length;d++){var e="mobiano"[d%7],f=c.charCodeAt(d)^e.charCodeAt(0);b+=String.fromCharCode(f)}return decodeURIComponent(atob(b))}catch(g){return console.error("\u7459\uff45\u7611\u6fb6\u8fab\u89e6:",g),""}},onPageLoaded:function(){var b=this.pageIndex;BookInfo.getBook().getRealBookIndex&&
...
var c=this.$container.width(),d=this.$container.height();var e=bookType===BookType.documentView_book||bookType===BookType.singleDocumentView_book?BookInfo.getBook().docViewBook.parameters?BookInfo.getBook().docViewBook.parameters.scale:1:BookInfo.getBook().flipBook.parameters?BookInfo.getBook().flipBook.parameters.scale:1;var f=this.selectStartPoint[0]/(c*e),g=this.selectStartPoint[1]/(d*e),h=b.deltaX,k=b.deltaY;bookConfig.upsideOnMobile()&&(h=b.deltaY,k=-b.deltaX);return{left:f,top:g,right:(this.selectStartPoint[0]+
h)/(c*e),bottom:(this.selectStartPoint[1]+k)/(d*e)}},getRealPoint:function(b){if((b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:b.changedTouches?b.changedTouches:[b])&&!(3<=b.length)){var c=this.$container.offset().left,d=this.$container.offset().top;var e=bookType===BookType.documentView_book||bookType===BookType.singleDocumentView_book?BookInfo.getBook().docViewBook.parameters?BookInfo.getBook().docViewBook.parameters.scale:1:BookInfo.getBook().flipBook.parameters?
BookInfo.getBook().flipBook.parameters.scale:1;this.$container.width();e*=this.$container.height();var f=b[0].pageX;b=b[0].pageY;return bookConfig.upsideOnMobile()?[b-d,e-(f-c)]:[f-c,b-d]}},onResize:function(){}}).extend(PageAttachment),PageAnimation=Class({create:function(b){this.$container=b.$container;this.pageIndex=b.pageIndex;this.page=b.page;this.width=b.width;this.height=b.height;this.$parent=b.$parent;this.bookType=b.bookType;this.callback=b.callback},pauseAnimation:function(){},startAnimation:function(){},
enterSide:function(){},leaveSide:function(){},onResize:function(b,c){},resetSlider:function(){},destroySlider:function(){},initReaderOrSlider:function(){},refreshEvent:function(){}}),PageEditorLoad=Class({statics:{isLoading:!1,isCompleted:function(){try{if(window.PageItem&&window.PageItem.HtmlVideo)return!0}catch(b){}}}}),PageHisliderLoad=Class({statics:{isLoading:!1,isCompleted:function(){try{if(window.hiSliderFactory)return!0}catch(b){}}}}),PageEditorAnimation=Class({create:function(b){this.$container=
b.$container;this.pageIndex=b.pageIndex;this.page=b.page;this.width=b.width;this.height=b.height;this.$parent=b.$parent;this.bookType=b.bookType;this.callback=b.callback;this.Items=new ObjectPool;this.needLoadResource()?this.loadResource():this.initPageEditor()},needLoadResource:function(){if(PageEditorLoad.isCompleted())return!0;for(var b=this.getPageAnnos()[this.pageIndex-1],c=0;c<b.length;c++){var d=b[c];if(d)if(d.annotype==PageEditor.AnnoType.ANNO_LINK){var e=c=b=void 0,f=void 0;if((null==(b=
d.action)?void 0:b.actionType)!=PageEditor.ActionType.GOTO_PAGE&&(null==(c=d.action)?void 0:c.actionType)!=PageEditor.ActionType.OPEN_URL&&(null==(e=d.action)?void 0:e.actionType)!=PageEditor.ActionType.SHOW_ARTICLE&&(null==(f=d.action)?void 0:f.actionType)!=PageEditor.ActionType.SLIDE_SHOW)return!0;break}else return!0}return!1},getPageAnnos:function(){var b=global.pageEditor;b instanceof Array||(b=b.pageAnnos);if(this.hasInverseEditor()){var c=b;b.length<inverseEditor.length&&(c=inverseEditor);for(var d=
0;d<c.length;d++){b[d]||(b[d]=[]);inverseEditor[d]||(inverseEditor[d]=[]);var e=inverseEditor[d];e&&e.length&&(e=e.map(function(f){return getInverseItem(f,this.width,this.height)}.bind(this)));b[d]=b[d].concat(e);inverseEditor[d]=[]}}return b},hasInverseEditor:function(){return window.inverseEditor&&window.inverseEditor&&window.inverseEditor.length},loadResource:function(){var b=this;this.loadInterval=window.setInterval(function(){PageEditorLoad.isCompleted()&&(window.clearInterval(b.loadInterval),
...
!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var p=0;k=function(){m(p,25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,B){if(!b)return!1;var w=
b.pageWidth,v=b.pageHeight,u=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(B=u(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(v*v-B*B):v-f*Math.sqrt(w*w-B*B));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",[d]),k.stop())}.bind(this);e()}},setFlipInterval:function(){this.flipInterval=function(){if(!this.flipIntervalManager.flipInterval||
...
f[0];g.indexOf("-");g=g.split("-");var h=g[0];g=g[1];h=parseInt(h);var k=g?parseInt(g):c;f=getPageNumberFormat(f[1]);for(var l=h;l<=k;l++){var m=(l-h)*f.addition+f.startPage;g="";0==f.type&&(g=m+"");1==f.type&&(g=parseRoman(m));2==f.type&&(g=parseRoman(m).toLowerCase());d[l]=String.format(f.page,g)}}else if(!isNaN(f[0]))h=parseInt(f[0]),d[h]=void 0==f[1]?"":f[1];else if(-1<f[0].indexOf("-"))for(g=f[0],g.indexOf("-"),g=g.split("-"),h=g[0],g=g[1],h=parseInt(h),k=g?parseInt(g):c,l=h;l<=k;l++)d[l]=void 0==
...
switchNormalImage:function(b){for(var c=0;c<this.pageArray.length;c++)this.pageArray[c]&&this.pageArray[c].switchNormalImage(b)},resizeSvg:function(b,c){for(var d=0;d<this.pageArray.length;d++)this.pageArray[d]&&this.pageArray[d].resizeSvg(b,c)}}),DocViewBookPage=Class({onPageLoaded:null,create:function(b,c,d,e){this.pageHeight=this.pageWidth=this.height=this.width=this.zIndex=0;this.pageIndex=b;this.pageArray=[];this.bookType=d;this.side=$("<div class='slide_side'></div>");this.side.css({position:"absolute",
width:"100%",height:"100%"});this.side.attr("id",c+b);this.init(b)},init:function(b){isNaN(b)||(this.pages=$("<div class='slide_pages'></div>"),this.pages.css("position","absolute"),this.initPages(b),this.setPageCss(),this.side.append(this.pages))},initEvent:function(){this.adContainer&&this.adContainer.css({"z-index":3});isBelowIE9()?this.pages.IEZoom({side:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)}):this.pages.zoom({side:this,zoomIn:this.zoomIn.bind(this),
zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)})},zoomIn:function(b){b=BookInfo.getBook();b.status_zoom=!0;b.adContainer&&b.adContainer.css({"z-index":1});StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(d){d.setAsZoomout();d.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!1);if(!isPhone()&&!isPad()){this.switchLargeImage();bookConfig.ZoomToolbarVisible&&!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),
this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+c+5));if(this.controlBar){var c="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+c+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&BookInfo.getBook().unMagnifierZoom()}},zoomOut:function(){var b=BookInfo.getBook();b.status_zoom=!1;b.flipping||!b.adContainer||1!=b.currentPageIndex||
bookConfig.isTheBookOpen||b.adContainer.css({"z-index":3});gotoPageFun(b.toPageIndex,!1,"change book type");StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(c){c.setAsZoomin();c.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!0);this.switchNormalImage();this.controlBar&&this.controlBar.setVisible(!1)},onZoomed:function(b){if(isPhone()||isPad()){var c=BookInfo.getBook(),d=BookInfo.getCurrentPages();if(void 0!=d&&null!=d)for(var e=0;e<
d.length;e++){var f=c.pageArray[d[e]];f&&(f.resizeSvg(Math.round(this.pageWidth*b.scale),Math.round(this.pageHeight*b.scale)),bookConfig.highDefinitionConversion?f.zoomInSideImage():(1<b.scale&&f.zoomInSideImage(),1==b.scale&&f.zoomOutSideImage()))}}else b&&!this.pages.parameters.resize&&(this.pages.parameters.resize=!0,b=this.pages.offset().left,c=this.pages.offset().top,b-=this.pages.parameters.left,c-=this.pages.parameters.top,d=this.pages.parameters.scale,1!=d&&(this.resizePages(parseInt(this.pageWidth*
d),parseInt(this.pageHeight*d)),d=1),d=transformCSS({tran:{x:b,y:c},scale:d,origin:{x:0,y:0}}),this.pages.css(d),this.pages.parameters&&(this.pages.parameters.tran={x:b,y:c},this.pages.parameters.scale=1,this.pages.parameters.toScale=1,this.pages.parameters.width=$(this.pages).width(),this.pages.parameters.height=$(this.pages).height(),this.pages.parameters.origin={x:0,y:0},this.pages.parameters.resize=!1))},mouseWheelFlip:function(){var b;this.side.parent().bind(_event._mousewheel,function(c){if(void 0!=
b&&150>new Date-b)var d=!1;else b=new Date,d=!0;if(!d)return!1;d=c.originalEvent;d=Math.max(-1,Math.min(1,d.wheelDelta||-d.detail));c=c.originalEvent?c.originalEvent:c;this.status_zoom&&(c={pointers:[{pageX:c.pageX,pageY:c.pageY},{pageX:c.pageX,pageY:c.pageY}]},0>d?this.controlBar&&this.controlBar.zoomDown(c):this.controlBar&&this.controlBar.zoomUp(c));!this.status_zoom&&bookConfig.mouseWheelFlip&&(0>d?nextPageFun("mouse wheel flip"):previousPageFun("mouse wheel flip"));if(bookConfig.mouseWheelFlip)return stopEvent(c),
!1}.bind(this))},initPages:function(b){b=bookConfig.isTheBookOpen?2*b:2*b-1;var c=b-1;var d=rightToLeft?b:c;b=rightToLeft?c:b;this.addPageArray([d,b]);this.leftPage=this.pageArray[d];this.rightPage=this.pageArray[b]},setPageCss:function(){var b=transformCSS({rotate:0,tran:{x:0,y:0}});!this.rightPage&&this.leftPage&&bookConfig.retainBookCenter?(this.leftPage.centerPage(),this.leftPage.setCSSByStyle(b)):!this.leftPage&&this.rightPage&&bookConfig.retainBookCenter?(this.rightPage.centerPage(),this.rightPage.setCSSByStyle(b)):
(this.leftPage&&(this.leftPage.setLeftOrRight(!0),this.leftPage.setCSSByStyle(b)),this.rightPage&&(this.rightPage.setLeftOrRight(!1),this.rightPage.setCSSByStyle(b)))},addPageArray:function(b){if(b&&this.pageArray)for(var c=0;c<b.length;c++)if(!(0>=b[c]||b[c]>originTotalPageCount||this.pageArray[b[c]])){var d=new Page(b[c],"page",this.bookType,this.onPageLoaded);d.hideMiddleShadow();d.onResize(this.pageWidth,this.pageHeight);this.pageArray[b[c]]=d;this.pages.append(d.side)}},fillContent:function(b){this.pageArray[b]&&
...
this.pageArray[c].addHistoryTexts(b)},highlightSearch:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].highlightSearch()},clearHighlight:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].clearHighlight()},resetSlider:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].resetSlider()},initReaderOrSlider:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].initReaderOrSlider&&
this.pageArray[b].initReaderOrSlider()},fillPage:function(b,c){for(var d=0;d<this.pageArray.length;d++)this.pageArray[d]&&this.pageArray[d].fillPage(b,c)},zoomInSideImage:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].zoomInSideImage()},zoomOutSideImage:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].zoomOutSideImage()},switchLargeImage:function(){for(var b=0;b<this.pageArray.length;b++)this.pageArray[b]&&this.pageArray[b].switchLargeImage()},
switchNormalImage:function(b){for(var c=0;c<this.pageArray.length;c++)this.pageArray[c]&&this.pageArray[c].switchNormalImage(b)},resizeSvg:function(b,c){for(var d=0;d<this.pageArray.length;d++)this.pageArray[d]&&this.pageArray[d].resizeSvg(b,c)}}),SingleDocViewBookPage=Class({initPages:function(b){this.addPageArray([b]);this.page=this.pageArray[b]},resetPages:function(){if(this.pages){var b=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/
100,c=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-parseFloat(bookConfig.visibleAreaTop))/100;c=fitPageWidthHeight(this.width,this.height,b,c);b=2*parseInt(c.x/2);c=parseInt(c.y);this.resizePages(b,c);this.pages.css({left:(this.width-b)/2+"px",top:(this.height-c)/2+"px"});b=transformCSS({rotate:0,tran:{x:0,y:0}});this.pages.css(b);this.pages.parameters&&(this.pages.parameters.tran={x:0,y:0},this.pages.parameters.scale=1,this.pages.parameters.toScale=1,this.pages.parameters.width=
$(this.pages).width(),this.pages.parameters.height=$(this.pages).height(),this.pages.parameters.origin={x:0,y:0},this.pages.parameters.resize=!1,this.pages.swipeInterval&&this.pages.swipeInterval.stop(),this.pages.animateInterval&&this.pages.animateInterval.stop(),this.pages.parameters.zoomFlag=!1,this.pages.parameters.zoomOut=!0,this.pages.parameters.toScale=1,this.pages.parameters.scale=1);this.controlBar&&this.controlBar.setVisible(!1)}},resizePages:function(b,c){this.pageWidth=b;this.pageHeight=
c;this.pages.css({width:this.pageWidth+"px",height:this.pageHeight+"px"});b=this.pageWidth;c=this.pageHeight;for(var d=0;d<this.pageArray.length;d++)if(this.pageArray[d])this.pageArray[d].onResize(b,c)}}).extend(DocViewBookPage),DocViewBook=Class({currentTran:0,marginTop:10,toNewPageIndex:-1,create:function(b){this._super(b);this.currentPageIndex=this.getRealBookIndex(b.currentPageIndex);this.mainPageIndex=this.getRealBookIndex(b.currentPageIndex);this.marginTop=bookConfig.pageSpacing;this.flippingTime=
1E3;this.initBook();this.initEvent()},initBook:function(){this.docViewBook=$("<div class='DocViewBook' id='DocViewBook' ></div>");this.docViewBook.css("position","absolute");this.parent.append(this.docViewBook);this.initAttachments()},initAttachments:function(){this.showPage=this.docViewBook;this.bookAttachments=new BookAttachmentsBuilder(this.flipBook,this.currentPageIndex,this,this.options.isDoublePage)},getBook:function(){return this.docViewBook},fillPage:function(b,c){if(b)for(var d=this.pageArray.length,
e=0;e<d;e++)this.pageArray[e]&&this.pageArray[e].fillPage(b,c),this.pageBackArray&&this.pageBackArray[e]&&this.pageBackArray[e].fillPage(b,c)},resetPages:function(b){if(!(isNaN(b)||0>=b)){var c=[b,b+1,b-1,b+2,b-2];this.unWrapPageExcludeArray(c);this.addPageArray(c);this.loading();this.currentPage=this.pageArray[b];this.nextPage=this.pageArray[b+1];this.previousPage=this.pageArray[b-1];this.setPageCss()}},addPageArray:function(b){if(b&&this.pageArray){for(var c=0;c<b.length;c++)if(!(0>=b[c]||b[c]>
this.pageLength()||(this.pageArray[b[c]]&&this.fillContent(b[c]),this.pageArray[b[c]]))){var d=this.newPage(b[c]);d.onResize(this.width,this.height);this.pageArray[b[c]]=d;this.fillContent(b[c]);this.docViewBook.append(d.getSide())}this.orderPages()}},setPagePosition:function(b,c){if(isPhone()||isPad()){var d=c*(this.height+this.marginTop);if(!this.jumping){var e;d=parseFloat(null==(e=this.pageArray[b])?void 0:e.side.css("top"));if(b!==this.currentPageIndex&&this.pageArray[b]){var f,g;d=null!=(g=
parseFloat(null==(f=this.pageArray[this.currentPageIndex])?void 0:f.side.css("top")))?g:0;d=c*(this.height+this.marginTop)+d}}c={top:d+"px"};this.pageArray[b]&&this.pageArray[b].setCSSByStyle(c)}else{f=c*(this.width+this.marginTop);if(!this.jumping){var h;f=parseFloat(null==(h=this.pageArray[b])?void 0:h.side.css("left"));if(b!==this.currentPageIndex&&this.pageArray[b]){var k;f=null!=(k=parseFloat(null==(d=this.pageArray[this.currentPageIndex])?void 0:d.side.css("left")))?k:0;f=c*(this.width+this.marginTop)+
f}}c={left:f+"px"};this.pageArray[b]&&this.pageArray[b].setCSSByStyle(c)}},orderPages:function(){this.sequenceList={};for(var b=this.pageArray.length,c=0,d=this.mainPageIndex+1;d<b;d++)this.pageArray[d]&&(rightToLeft?c--:c++,this.pageArray[d].sequence=c,this.sequenceList[c]=d,this.setPagePosition(d,c));c=0;for(b=this.mainPageIndex;0<b;b--)this.pageArray[b]&&(this.pageArray[b].sequence=c,this.sequenceList[c]=b,this.setPagePosition(b,c),rightToLeft?c++:c--)},setPageCss:function(){var b=transformCSS({rotate:0,
tran:{x:0,y:0}});this.currentPage&&this.currentPage.setCSSByStyle(b);this.previousPage&&this.previousPage.setCSSByStyle(b);this.nextPage&&this.nextPage.setCSSByStyle(b)},fillContent:function(b){this.pageArray[b]&&this.pageArray[b].fillImage()},newPage:function(b){return new DocViewBookPage(b,"slidePage",this.bookType)},pageLength:function(){return bookConfig.totalPageCount},unWrapPageExcludeArray:function(b){if(b&&this.pageArray){for(var c=this.pageArray.length,d=0;d<c;d++)!this.pageArray[d]||0<=
b.indexOf(d)||(this.pageArray[d].remove(),this.pageArray[d]=void 0);this.orderPages()}},mouseWheelFlip:function(){if(bookConfig.mouseWheelFlip){var b;this.docViewBook.bind(_event._mousewheel,function(c){if(void 0!=b&&150>(new Date).getTime()-b)var d=!1;else b=(new Date).getTime(),d=!0;if(!d)return!1;d=c.originalEvent;var e=Math.max(-1,Math.min(1,d.wheelDelta||-d.detail));this.status_zoom&&(c={pointers:[{pageX:c.pageX,pageY:c.pageY},{pageX:c.pageX,pageY:c.pageY}]},0>e?this.controlBar&&this.controlBar.zoomDown(c):
this.controlBar&&this.controlBar.zoomUp(c));this.status_zoom||!bookConfig.mouseWheelFlip||this.flipping||(this.panBookForMove(d.wheelDelta),this.restrictInBoundary());if(bookConfig.mouseWheelFlip)return stopEvent(c),!1}.bind(this))}},flippingTo:function(b){this.currentPageIndex=b;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex)},getRealPageIndex:function(){return this.currentPageIndex},getRealBookIndex:function(b){return b},
gotoPage:function(b,c){if(!isNaN(b)){this.toPageIndex=b;if(this.status_zoom)return b={pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]},this.docViewBook.onDoubleTap.bind(this.docViewBook)(b),!0;b=this.getRealBookIndex(b);0>=b||b>this.pageLength()||!this.flipEffect(b)||(!c&&flipHistory&&flipHistory.addFromCurrentIndex(this.toPageIndex),bookConfig.restorePageVisible&&window.localStorage.setItem(realLocation+"?historyPageIndex",this.toPageIndex),this.flipping=!1,-1!==this.toNewPageIndex?(this.flippingTo(b),
playFlipSound(),this.mainPageIndex=b,this.resetPages(b),this.setAttachmentAfterFlipTo()):(c=1<Math.abs(b-this.currentPageIndex),this.flipInterval&&this.flipInterval.stop(),c?(this.jumping=!0,this.flippingTo(b),playFlipSound(),this.refreshPages(b),this.afterFlipTo(),this.jumping=!1):this.flipIntervalTmp(b)))}},flipEffect:function(b){return this.status_zoom||b==this.currentPageIndex?!1:!0},flipIntervalTmp:function(b){var c=this.currentTran,d=this.getFlipTo(b);this.flipping=!0;var e=0;console.log("flipIntervalTmp",
this.flipping);var f=function(g,h,k){g<h?(g=(0,$.easing["easeInOut"+k])(null,g,c,d-c,h),h=g-e,e=g,this.panBookForMove(h)):(this.flipping=!1,this.flipInterval.stop(),BookEvent.trigger("afterFlipPage",[b]))}.bind(this);this.flipInterval=function(g,h){f(g,h,"Sine")}.animation(this,this.flippingTime)},refreshPages:function(b){if(!this.pageArray[b]){var c=this.getCurrentViewPageIndex(),d=isPhone()||isPad()?this.currentTran-this.height:this.currentTran-this.width;(b>c||b<this.mainPageIndex)&&!rightToLeft&&
(d=this.currentTran);(b<c||b>this.mainPageIndex)&&rightToLeft&&(d=this.currentTran);this.addPageArray([b-1,b,b+1]);this.setBookTran(d)}this.showPage=this.pageArray[b].pages},getCurrentViewPageIndex:function(){var b=Math.abs(this.currentTran),c=0>=this.currentTran?1:-1;b=isPhone()||isPad()?Math.floor(b/this.height)+1+(b%this.height>this.height/2)?0:1:Math.floor(b/this.width)+1+(b%this.width>this.width/2)?0:1;return this.sequenceList[c*b]},getFlipTo:function(b){if(!this.pageArray[b]||!this.pageArray[b].sequence)return 0;
var c=isPhone()||isPad()?this.height+this.marginTop:this.width+this.marginTop;b=this.pageArray[b];var d=0;if(this.pageArray[this.currentPageIndex]){var e,f;d=isPhone()||isPad()?null==(e=this.pageArray[this.currentPageIndex])?void 0:e.side.css("top"):null==(f=this.pageArray[this.currentPageIndex])?void 0:f.side.css("left")}return-b.sequence*c-parseFloat(d)},getCurrentTran:function(){return this.currentTran},setBookTran:function(b){if(isPhone()||isPad()){var c=transformCSS({rotate:0,tran:{x:0,y:b}});
isBelowIE9()&&(c={top:b+this.bookTop+"px"})}else c=transformCSS({rotate:0,tran:{x:b,y:0}}),isBelowIE9()&&(c={left:b+this.bookLeft+"px"});this.setCSSByStyle(c);this.currentTran=b},onResize:function(){this.resize();this.status_zoom=!1;this.showPage=this.pageArray[this.currentPageIndex].pages},resize:function(){this.endFlip();this.resizeBook();this.resizePage(this.width,this.height);this.resetPages(this.currentPageIndex);this.resizeAdvertisement()},getTop:function(){return this.bookTop},resizeBook:function(){var b=
bookConfig.topMargin+templateArea.getTopHeight(),c=bookConfig.bottomMargin+templateArea.getBottomHeight(),d=bookConfig.leftMargin+templateArea.getLeftWidth(),e=bookConfig.rightMargin+templateArea.getRightWidth();e=windowWidth-d-e;c=windowHeight-b-c;var f=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/100,g=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-parseFloat(bookConfig.visibleAreaTop))/100;f=fitPageWidthHeight(e,
c,f,g);this.width=parseInt(f.x);this.height=parseInt(f.y);this.bookTop=b+(c-this.height)/2;this.bookLeft=d+(e-this.width)/2;useTheAliCloudChart(parseInt(f.x),this.height);this.docViewBook.css({width:this.width+"px",height:this.height+"px",left:this.bookLeft+"px",top:this.bookTop+"px"})},resizeAdvertisement:function(){var b=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/100,c=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-
parseFloat(bookConfig.visibleAreaTop))/100;b=fitPageWidthHeight(this.width,this.height,b,2*c);this.pageWidth=parseInt(b.x);this.pageHeight=2*parseInt(b.y/2)},resizePage:function(b,c,d){d=this.pageArray.length;for(var e=0;e<d;e++)this.pageArray[e]&&(this.pageArray[e].onResize(b,c),this.pageArray[e].controlBar&&this.pageArray[e].controlBar.setVisible(!1))},getHeight:function(){return this.height},getWidth:function(){return this.width},getScale:function(){return this.currentPage.pages.parameters.toScale},
getCssLeft:function(){return parseInt(this.docViewBook.css("left"))},getCssTop:function(){return parseInt(this.docViewBook.css("top"))},checkFlipping:function(){this.flipping=!1;this.loading();this.fillContent(this.currentPageIndex)},afterFlipTo:function(){this.mainPageIndex=this.currentPageIndex;this.resetPages(this.currentPageIndex);this.setBookTran(0);this.startTran=this.currentTran;this.checkFlipping();this.setAttachmentAfterFlipTo()},setAttachmentBeforeFlipTo:function(){this.bookAttachments.setAttachmentBeforeFlipTo()},
setAttachmentAfterFlipTo:function(){this.stopMedia();this.resetSlider();this.flipping||this.enterPage();bookConfig.ThumbnailsButtonVisible&&thumbnail.clearHighLight();bookConfig.ThumbnailsButtonVisible&&thumbnail.setHighLight(this.getRealPageIndex());window.resizeBookAfterFlip&&!this.flipping&&window.setTimeout(function(){onStageResize()},30)},endFlip:function(){this.flipping=!1},loading:function(){this.flipping||this.pageArray[this.currentPageIndex]&&this.pageArray[this.currentPageIndex].loading()},
getCurrentPageIndex:function(){return this.getRealPageIndex()},getCurrentPages:function(){return[this.currentPageIndex]},setCSSByStyle:function(b){this.docViewBook.css(b)},setShow:function(b){},hide:function(){Log.debug("slide book hide.");this.visible=!1;this.setCSSByStyle({display:"none"});this.stopMedia();this.resetSlider();this.bookAttachments&&this.bookAttachments.hide()},show:function(){Log.debug("slide book show.");this.visible=!0;this.setCSSByStyle({display:"block"});this.enterPage();this.bookAttachments&&
this.bookAttachments.show()},enterPage:function(){this.afterChangeBookType();this.openShownMedia();this.addSearchHighlight()},addSearchHighlight:function(){var b=this.currentPageIndex;this.pageArray[b]&&this.pageArray[b].highlightSearch()},clearSearchHighlight:function(){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].clearHighlight()},openShownMedia:function(){var b=this.currentPageIndex;this.pageArray[b]&&this.pageArray[b].enterSide();this.pageArray[b]&&this.pageArray[b].addHistoryTexts()},
stopMedia:function(){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].leaveSide()},resetSlider:function(){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].resetSlider()},afterChangeBookType:function(){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].initReaderOrSlider()},select:function(){this.selected=!0;var b=this.currentPageIndex;if(this.pageArray[b]){if(this.pageArray[b]){this.pageArray[b].initSelectTextEvent();
var c=this.pageArray[b].page;c&&c.pageAttachments.$select&&c.pageAttachments.$select.css({width:this.width+"px",height:this.height+"px"})}this.pageArray[b].pages.parameters&&(this.pageArray[b].pages.parameters.eventCancel=!0);this.docViewBook.parameters&&(this.docViewBook.parameters.eventCancel=!0)}},unSelect:function(){this.selected=!1;var b=this.getCurrentPages();if(void 0!=b&&null!=b){for(var c=0;c<b.length;c++){var d=b[c];this.pageArray[d]&&(this.pageArray[d]&&this.pageArray[d].destroySelect(),
this.pageArray[d].pages.parameters&&(this.pageArray[d].pages.parameters.eventCancel=!1))}this.docViewBook.parameters&&(this.docViewBook.parameters.eventCancel=!1);StateSynchronous.instance().findButtons("SelectTextButton",!0).each(function(e){e.setAsUnSelect();e.executeCallback()})}},magnifierZoom:function(){this.selected=!0;var b=this.currentPageIndex;this.pageArray[b]&&this.pageArray[b]&&this.pageArray[b].initMagnifierEvent()},unMagnifierZoom:function(){this.selected=!1;var b=BookInfo.getCurrentPages();
if(void 0!=b&&null!=b){for(var c=0;c<b.length;c++){var d=b[c];this.pageArray[d]&&this.pageArray[d]&&this.pageArray[d].destroyMagnifier()}bookConfig.MagnifierButtonVisible&&window.magnifierZoomBox&&window.magnifierZoomBox.hide();StateSynchronous.instance().findButtons("magnifier",!0).each(function(e){e.setAsZoomin()})}},switchLargeImage:function(){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].switchLargeImage()},switchNormalImage:function(b){for(var c=this.pageArray.length,
d=0;d<c;d++)this.pageArray[d]&&this.pageArray[d].switchNormalImage(b)},destroy:function(){},zoomIn:function(){this.status_zoom=!0;StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(c){c.setAsZoomout();c.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!1);if(!isPhone()&&!isPad()){this.switchLargeImage();bookConfig.ZoomToolbarVisible&&!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),this.controlBar.setPosition((windowWidth-
this.controlBar.width)/2,templateArea.getTopHeight()+b+5));if(this.controlBar){var b="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+b+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&this.unMagnifierZoom()}},zoomOut:function(){this.status_zoom=!1;gotoPageFun(this.toPageIndex,!1,"change book type");StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(b){b.setAsZoomin();
b.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!0);this.controlBar&&this.controlBar.setVisible(!1)},onZoomed:function(b){console.log(b);if(b&&!this.docViewBook.parameters.resize){this.docViewBook.parameters.resize=!0;b=this.docViewBook.offset().left;var c=this.docViewBook.offset().top;b-=this.docViewBook.parameters.left;c-=this.docViewBook.parameters.top;var d=this.docViewBook.parameters.scale,e=transformCSS({tran:{x:b,y:c},scale:d,origin:{x:0,y:0}}),f=
this.pageArray.length,g=parseInt(this.width*d),h=parseInt(this.height*d);console.log(this.width,this.height,this.width*d);for(var k=0;k<f;k++)if(this.pageArray[k])for(var l=this.pageArray[k].pageArray,m=0;m<l.length;m++)if(l[m]){var p=l[m];if(p.pageAttachments){var q=fitPageWidthHeight(g,h,p.imageWidth,p.imageHeight);p.pageAttachments.onResize(q.x,q.y,g,h);console.log(p.pageAttachments.$animation,g,h);p.pageAttachments.$animation&&p.pageAttachments.$animation.css({transform:"scale("+1/d+")","transform-origin":"0 0",
"will-change":"transform"});p.pageAttachments.$select&&p.pageAttachments.$select.css({width:this.width+"px",height:this.height+"px"})}p.pageBackground&&(p.pageBackground.onResize(g,h),console.log("urlType",p.pageBackground.urlType),(!isPhone()&&!isPad()||[4,5].includes(p.pageBackground.urlType))&&p.sideImage.css({width:g+"px",height:h+"px",transform:"scale("+1/d+")","transform-origin":"0 0","will-change":"transform"}))}this.docViewBook.css(e);this.docViewBook.parameters&&(this.docViewBook.parameters.tran=
{x:b,y:c},this.docViewBook.parameters.width=$(this.docViewBook).width(),this.docViewBook.parameters.height=$(this.docViewBook).height(),this.docViewBook.parameters.origin={x:0,y:0},this.docViewBook.parameters.resize=!1)}}}).extend(Book);
DocViewBook.expand({initEvent:function(){this.moveDirectionType={MOVE_LEFT:-1,MOVE_RIGHT:1,MOVE_NONE:0};this.mouseMoveDirection=this.moveDirectionType.MOVE_NONE;this.hammerEventModular();this.mouseWheelFlip()},hammerEventModular:function(){var b=new Hammer.Manager(this.docViewBook[0]);b.add(new Hammer.Pan);b.add((new Hammer.Swipe).recognizeWith(b.get("pan")));b.add(new Hammer.Press({time:"1000"}));b.add(new Hammer.Pinch);b.add(new Hammer.Tap({event:"doubletap",taps:2}));b.on("panstart panmove panend pancancel",
this.onPan.bind(this));b.on("press",this.onPress.bind(this));this.docViewBook.bind("click",this.onTap.bind(this));b.on("swipe swipeup",this.onSwipe.bind(this));this.docViewBook.bind("mouseover ",this.onOver.bind(this));this.docViewBook.bind("mouseout ",this.onOut.bind(this));this.docViewBook.bind(_event._down,this.onDown.bind(this));$("body").bind(_event._end+" "+_event._leave,this.onUp.bind(this));this.initZoomEvent()},onPan:function(b){if(!this.selected){this.animateInterval&&this.animateInterval.stop();
this.swipeInterval&&this.swipeInterval.stop();var c=this.getDelta(b);"panstart"===b.type&&(this.startMove=0,document.documentElement.style.cursor="grabbing",document.body.style.cursor="grabbing");if("panmove"===b.type){c=isPhone()||isPad()||bookConfig.upsideOnMobile()?c.deltaY:c.deltaX;var d=c-this.startMove;this.startMove=c;this.panBookForMove(d)}if("panend"==b.type||"pancancel"==b.type)document.documentElement.style.cursor="grab",document.body.style.cursor="grab",this.restrictInBoundary()}},onSwipe:function(b){if(!this.selected){this.animateInterval&&
this.animateInterval.stop();this.swipeInterval&&this.swipeInterval.stop();var c=isPhone()||isPad()||bookConfig.upsideOnMobile(),d=parseFloat(this.pageArray[this.currentPageIndex].side.css(c?"top":"left")),e=bookConfig.RightToLeft?1:bookConfig.totalPageCount;if(this.currentPageIndex===(bookConfig.RightToLeft?bookConfig.totalPageCount:1)&&0<d||this.currentPageIndex===e&&0>d)this.restrictInBoundary();else{var f=0,g=0;b=this.getVelocity(b);f=b.velocityX;g=b.velocityY;this.swipeInterval=function(h,k){var l=
(k-h)/k;this.panBookForMove(3*(c?g*l:f*l),!0);h>=k&&(this.swipeInterval.stop(),this.restrictInBoundary(),this.startTran=this.currentTran,this.panstart=this.fingleDown=!1)}.animation(this,320)}}},onPress:function(b){},onTap:function(b){onWindowTap(b.srcEvent)},onOut:function(){document.documentElement.style.cursor="default";document.body.style.cursor="default"},onOver:function(b){this.selected||(document.documentElement.style.cursor="grab",document.body.style.cursor="grab")},onDown:function(b){this.fingleDown=
!0},onUp:function(b){this.swipeInterval||this.flipping||!this.fingleDown||(30<=Math.abs(this.currentTran-this.startTran)&&(this.currentTran>this.startTran&&!rightToLeft||this.currentTran<this.startTran&&rightToLeft?previousPageFun("window click"):this.currentTran!=this.startTran&&nextPageFun("window click")),this.startTran=this.currentTran,this.panstart=this.fingleDown=!1,this.onBack())},onBack:function(){if(0!=this.currentTran&&!this.flipping){this.flipping=!0;var b=this.currentTran,c=function(d,
e,f){d<e?(d=(0,$.easing["easeInOut"+f])(null,d,b,0-b,e),this.setBookTran(d)):(this.flipping=!1,this.flipInterval.stop(),this.setBookTran(0),this.startTran=this.currentTran)}.bind(this);this.flipInterval=function(d,e){c(d,e,"Sine")}.animation(this,this.flippingTime)}},initZoomEvent:function(){isBelowIE9()?this.docViewBook.IEZoom({side:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)}):this.docViewBook.zoom({isSeries:!0,side:this,zoomIn:this.zoomIn.bind(this),
zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)})},dragChangePage:function(b){gotoPageFun(b,!1)},getVelocity:function(b){var c=0,d=0,e=bookConfig.upsideOnMobile();0==b.velocityX||e||(c=b.velocityX);0==b.velocityY||e||(d=b.velocityY);0!=b.velocityX&&e&&(c=b.velocityY);0!=b.velocityY&&e&&(d=-b.velocityX);return{velocityX:c,velocityY:d}},getDelta:function(b){var c=0,d=0,e=bookConfig.upsideOnMobile();0==b.deltaX||e||(c=b.deltaX);0==b.deltaY||e||(d=b.deltaY);0!=b.deltaX&&e&&(c=b.deltaY);
0!=b.deltaY&&e&&(d=-b.deltaX);return{deltaX:c,deltaY:d}},panBookForMove:function(b){var c=isPhone()||isPad()||bookConfig.upsideOnMobile(),d=c?this.height+this.marginTop:this.width+this.marginTop,e=c?"top":"left";c=c?"height":"width";this.status_zoom&&(b/=this.docViewBook.parameters.scale);for(var f=0;f<this.pageArray.length;f++){var g=this.pageArray[f];if(g){var h=parseFloat(g.side.css(e))+b,k=d*g.sequence;if((1===this.currentPageIndex&&h>k||this.currentPageIndex===bookConfig.totalPageCount&&h<k)&&
this.status_zoom){this.disableDriection=!1;return}this.disableDriection=!0;g.pageIndex===this.currentPageIndex&&-1===this.toNewPageIndex&&(h<-this[c]/2&&0>b&&(this.toNewPageIndex=bookConfig.RightToLeft?this.currentPageIndex-1:this.currentPageIndex+1),h>this[c]/2&&0<b&&(this.toNewPageIndex=bookConfig.RightToLeft?this.currentPageIndex+1:this.currentPageIndex-1));k={};g.setCSSByStyle((k[e]=h+"px",k))}}this.toNewPageIndex<=bookConfig.totalPageCount&&0<this.toNewPageIndex&&this.dragChangePage(this.toNewPageIndex);
this.toNewPageIndex=-1},restrictInBoundary:function(){if(1===this.currentPageIndex||this.currentPageIndex===bookConfig.totalPageCount){this.animateInterval&&this.animateInterval.stop();var b=isPhone()||isPad()||bookConfig.upsideOnMobile()?"top":"left",c=parseFloat(this.pageArray[this.currentPageIndex].side.css(b)),d=bookConfig.RightToLeft?1:bookConfig.totalPageCount;if(this.currentPageIndex===(bookConfig.RightToLeft?bookConfig.totalPageCount:1)&&0<c||this.currentPageIndex===d&&0>c){var e=0,f=0;e=
c;this.animateInterval=function(g,h){g=$.easing.easeOutBack(null,f,0,e,20);0<f&&(g-=$.easing.easeOutBack(null,f-1,0,c,20));for(h=0;h<this.pageArray.length;h++){var k=this.pageArray[h];if(k){var l=parseFloat(k.side.css(b)),m={};k.setCSSByStyle((m[b]=l-g+"px",m))}}f++}.animation(this,320)}}}});
var DoubleDocViewBook=Class({getRealPageIndex:function(){var b=2*this.currentPageIndex-1;return b=Number.between(b,1,bookConfig.totalPageCount)},getRealBookIndex:function(b){b=bookConfig.isTheBookOpen?Math.ceil(b/2):parseInt(b/2)+1;return b=Number.between(b,1,this.pageLength())},pageLength:function(){return bookConfig.isTheBookOpen?Math.ceil(bookConfig.totalPageCount/2):parseInt(bookConfig.totalPageCount/2)+1}}).extend(DocViewBook),SingleDocViewBook=Class({getRealPageIndex:function(){var b=this.currentPageIndex;
return b=Number.between(b,1,bookConfig.totalPageCount)},getRealBookIndex:function(b){return b=Number.between(b,1,bookConfig.totalPageCount)},pageLength:function(){return bookConfig.totalPageCount},newPage:function(b){return new SingleDocViewBookPage(b,"slidePage",this.bookType)}}).extend(DocViewBook),PcDoubleDocViewBook=Class({bookType:BookType.slide_book,create:function(b){this._super(b)},onResize:function(){this._super()},initBook:function(){this._super();this.docViewBook.css("display","none")}}).extend(DoubleDocViewBook),
PcSingleDocViewBook=Class({bookType:BookType.singleDocumentView_book,create:function(b){this._super(b)},onResize:function(){this._super();this.bookAttachments&&this.bookAttachments.onResize(this.width,this.height)}}).extend(SingleDocViewBook),IssuuPage=Class({create:function(b,c,d,e){this._super(b,c,d,e);this.renderPage();this.addFlipShadow()},remove:function(){this.sideImage&&this.sideImage.remove();this.side.remove();this.sideImage=this.side=void 0;this.pageBackground&&this.pageBackground.destroy();
this.render&&(this.render.taskPool.stop(),this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0));this.hasReader&&this.destroySlider()},destroy:function(){this.pageBackground&&this.pageBackground.destroy();this.sideImage=this.side=void 0;this.hasReader&&this.destroySlider()},hasReader:function(){return window.readerConfig&&0<window.readerConfig.pages.length&&window.readerConfig.pages.length>=this.pageIndex&&(this.hasReaderItems()||window.inverseEditor&&window.inverseEditor.length&&
window.inverseEditor[this.pageIndex-1]&&window.inverseEditor[this.pageIndex-1].length)?!0:!1},hasReaderItems:function(){var b=window.readerConfig.pages[this.pageIndex-1];return b&&0!==Object.values(b).filter(function(c){return Array.isArray(c)&&c.length}).length},loading:function(){"restrict"==BookRestrict.isRestrictPage(this.pageIndex)||this.originalImageLoaded||this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+
bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))},unLoading:function(b){this.hasReader()&&!b||!this.loadingImage||(this.loadingImage.css({display:"none"}),this.loadingImage.remove(),this.loadingImage=null)},restrict:function(){if(!this.restrictImage){this.restrictImage=$("<div class='loadingOuter'></div>");var b=1==this.pageIndex?getMeta("og:image"):bookConfig.pageRestrictUrl;this.restrictImage.css({"background-image":"url("+b+")"});1==this.pageIndex?this.restrictImage.css({"background-size":"contain"}):
this.restrictImage.css({"background-size":"auto"});this.mirrorRestrict();this.sideContent.append(this.restrictImage)}},unRestrict:function(){this.restrictImage&&(this.restrictImage.remove(),this.restrictImage=null)},mirrorRestrict:function(){if(this.isMirrorSide&&this.restrictImage){var b="scaleX(-1)";bookConfig.FlipDirection&&(b="scaleY(-1)");this.restrictImage.css({"-webkit-transform":b,"-moz-transform":b,"-o-transform":b,"-ms-transform":b,opacity:.2})}},mirrorSide:function(){this.isMirrorSide=
!0;var b="scaleX(-1)";bookConfig.FlipDirection&&(b="scaleY(-1)");this.sideImage.css({"-webkit-transform":b,"-moz-transform":b,"-o-transform":b,"-ms-transform":b,opacity:.2});this.rendering&&(this.rendering.destroy(),this.rendering=null);this.unLoading()},fillPreviewImage:function(){var b=this,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return bookConfig.loadPreviewImage?b.isMirrorSide||window.sliderJS&&window.sliderJS[b.pageIndex-1]&&sliderJS[b.pageIndex-
...
var IssuuHardSide=Class({create:function(b,c,d,e){this._super(b,c,d,e);this.isHard=!0},addFlipShadow:function(){},renderPage:function(){}}).extend(IssuuPage),IssuuHardPage=Class({create:function(b,c,d,e,f){this._super(b,c,d,e,f);this.isHardPage=!0;this.borderWidth=bookConfig.hardCoverBorderWidth;this.outerCoverBorder=bookConfig.outerCoverBorder||BookInfo.isInnerPage(b,e);this.$page=$("<div class='hardSide' style='background-color:"+bookConfig.borderColor+";'></div>");this.$page.append(this.page.side);
this.page.side.addClass("pageSide");this.renderPage()},newPage:function(b,c,d,e){this.page=new IssuuHardSide(b,c,d,e)},setLeftOrRight:function(b){(this.isLeft=b)?this.setCSSByName("left-side"):this.setCSSByName("right-side");var c=b&&this.outerCoverBorder?this.borderWidth:0,d=bookConfig.cornerRound;b?(this.$page.css({"border-radius":d+"px 0px 0px "+d+"px"}),this.$page.css({"margin-top":-this.borderWidth+"px","margin-left":-this.borderWidth+"px"})):(this.$page.css({"border-radius":"0px "+d+"px "+d+
"px 0px"}),this.$page.css({"margin-top":-this.borderWidth+"px","margin-right":-this.borderWidth+"px"}));this.page.side.css({left:c+"px"})},setUpOrDown:function(b){(this.isUp=b)?this.setCSSByName("up-side"):this.setCSSByName("down-side");var c=b&&this.outerCoverBorder?this.borderWidth:0,d=bookConfig.cornerRound;b?(this.$page.css({"border-radius":d+"px "+d+"px 0px 0px"}),this.$page.css({"margin-top":-this.borderWidth+"px","margin-left":-this.borderWidth+"px"})):(this.$page.css({"border-radius":"0px 0px "+
d+"px "+d+"px"}),this.$page.css({"margin-bottom":-this.borderWidth+"px","margin-left":-this.borderWidth+"px"}));this.page.side.css({top:c+"px"})},onResize:function(b,c,d){this.pageWidth=b;this.pageHeight=c;bookConfig.FlipDirection?(this.width=b+2*this.borderWidth,this.height=c+this.borderWidth,this.pageWidth=this.outerCoverBorder?b:b+2*this.borderWidth,this.pageHeight=this.outerCoverBorder?c:c+this.borderWidth):(this.width=b+this.borderWidth,this.height=c+2*this.borderWidth,this.pageWidth=this.outerCoverBorder?
b:b+this.borderWidth,this.pageHeight=this.outerCoverBorder?c:c+2*this.borderWidth);if(this.page)this.page.onResize(this.pageWidth,this.pageHeight);this.$page.css({width:this.width,height:this.height});bookConfig.FlipDirection?this.page.side.css({left:this.outerCoverBorder?this.borderWidth:0}):this.page.side.css({top:this.outerCoverBorder?this.borderWidth:0});if(this.rendering)this.rendering.onResize(b,c)},renderPage:function(){this.rendering&&(this.rendering.destroy(),this.rendering=null);this.rendering=
new PageRendering(this.$page,this.pageIndex,this.bookType);this.rendering.onResize(this.width,this.height);this.rendering.render()},beginToFlip:function(){},setHardCover:function(b,c,d,e,f){this.outerCoverBorder=bookConfig.outerCoverBorder||BookInfo.isInnerPage(this.pageIndex,this.bookType);this.$page.css("background-color",bookConfig.borderColor);this.borderWidth!=bookConfig.hardCoverBorderWidth&&(this.borderWidth=bookConfig.hardCoverBorderWidth,bookConfig.FlipDirection?this.setUpOrDown(this.isUp):
this.setLeftOrRight(this.isLeft),this.onResize(this.pageWidth,this.pageHeight));this.renderPage()}}).extend(PageInterface),IssuuHardCover=Class({create:function(b){this.parent=b;this.borderWidth=bookConfig.hardCoverBorderWidth;this.rightToLeft=bookConfig.RightToLeft;this.cover=$("<div class='hardCover'></div>");this.initPage();this.initBookSpine();this.parent.append(this.cover)},initPage:function(){var b=BookInfo.getHardCoverPages(!0);this.leftPage=new IssuuHardPage(b[0],"coverPage",!1,BookType.normal_book);
this.rightPage=new IssuuHardPage(b[1],"coverPage",!1,BookType.normal_book);this.cover.append(this.leftPage.$page);this.cover.append(this.rightPage.$page);this.leftPage.rendering.midCoil&&this.leftPage.rendering.midCoil.hide();this.rightPage.rendering.midCoil&&this.rightPage.rendering.midCoil.hide();this.leftPage.setLeftOrRight(!0);this.rightPage.setLeftOrRight(!1);this.leftPage.setCSSByStyle({top:"0",left:"0","margin-top":0,"margin-left":0});this.rightPage.setCSSByStyle({top:"0",right:"0","margin-top":0,
"margin-right":0})},initBookSpine:function(){this.topSpine=new IssuuBookSpine(this.cover);this.bottomSpine=new IssuuBookSpine(this.cover);this.topSpine.setCSSByName("top_spine");this.bottomSpine.setCSSByName("botoom_spine")},onResize:function(b,c,d){d||(d=1);if(this.leftPage)this.leftPage.onResize(b[0].x*d,b[0].y*d);if(this.rightPage)this.rightPage.onResize(b[1].x*d,b[1].y*d);this.topSpine.onResize(c);this.bottomSpine.onResize(c);this.topSpine.setCSSByStyle({left:b[0].x*d+this.borderWidth+"px"});
this.bottomSpine.setCSSByStyle({left:b[0].x*d+this.borderWidth+"px"});this.pagesWhArray=[{x:b[0].x*d,y:b[0].y*d},{x:b[1].x*d,y:b[1].y*d}];this.resizeCover((b[0].x+b[1].x)*d,b[0].y*d,c);b=transformCSS({scale:{x:1,y:1}});this.leftPage&&this.leftPage.$page.css(b);this.rightPage&&this.rightPage.$page.css(b);this.topSpine.setCSSByStyle(b);this.bottomSpine.setCSSByStyle(b)},resizeCover:function(b,c,d){this.thicknessWidthArray=d;this.width=b+(d[0]+d[1])+2*this.borderWidth;this.height=c+2*this.borderWidth;
this.cover.css({width:this.width+"px",height:this.height+"px",left:-(this.borderWidth+d[0])+"px",top:-this.borderWidth+"px"})},refresh:function(b,c,d){this.refreshBookSpine(c);this.refreshPage(b,d);this.resizeCover(this.pagesWhArray[0].x+this.pagesWhArray[1].x,this.pagesWhArray[0].y,c)},getSensitiveIndex:function(){return BookInfo.getSensitiveIndex(!0)},refreshPage:function(b,c){var d=this.getSensitiveIndex().min,e=this.getSensitiveIndex().max;if(b<=d||b>=e){if(b<=d&&bookConfig.RightToLeft||!bookConfig.RightToLeft&&
b>=e)this.rightPage&&this.rightPage.setVisible(!1),(c<e&&bookConfig.RightToLeft||c>d&&!bookConfig.RightToLeft)&&this.leftPage&&this.leftPage.setVisible(!0);if(b<=d&&!bookConfig.RightToLeft||bookConfig.RightToLeft&&b>=e)this.leftPage&&this.leftPage.setVisible(!1),(c<e&&!bookConfig.RightToLeft||c>d&&bookConfig.RightToLeft)&&this.rightPage&&this.rightPage.setVisible(!0);this.hideBookSpine()}else this.showBookSpine(),this.leftPage&&this.leftPage.setVisible(!0),this.rightPage&&this.rightPage.setVisible(!0)},
doSetMovingScale:function(b,c){var d=transformCSS({scale:{x:b.x,y:b.y}});c=transformCSS({scale:{x:c.x,y:c.y}});this.leftPage&&this.leftPage.$page.css(d);this.rightPage&&this.rightPage.$page.css(c);b=transformCSS({scale:{x:1,y:b.y}});this.topSpine.setCSSByStyle(b);this.bottomSpine.setCSSByStyle(b)},refreshBookSpine:function(b){this.topSpine.refresh(b);this.bottomSpine.refresh(b)},hideBookSpine:function(){this.topSpine.hide();this.bottomSpine.hide()},showBookSpine:function(){this.topSpine.show();this.bottomSpine.show()},
show:function(){this.cover.show()},hide:function(){this.cover.hide()}}),IssuuBookSpine=Class({create:function(b){this.parent=b;this.initSpine()},initSpine:function(){this.height=bookConfig.hardCoverBorderWidth;this.bookSpine=$("<div class='bookSpine'></div>");this.bookSpine.css({height:"100%","background-color":bookConfig.borderColor});this.parent.append(this.bookSpine);this.addShadow()},addShadow:function(){this.leftShadow=$("<div class='left_shadow shadow'></div>");this.rightShadow=$("<div class='right_shadow shadow'></div>");
this.bookSpine.append(this.leftShadow);this.bookSpine.append(this.rightShadow)},refresh:function(b){this.onResize(b)},show:function(){this.bookSpine.show()},hide:function(){},setCSSByStyle:function(b){this.bookSpine.css(b)},setCSSByName:function(b){this.bookSpine.attr("class",b);this.bookSpine.addClass("bookSpine")},onResize:function(b){this.width=b[0]+b[1];this.bookSpine.css({width:this.width})}}),IssuuSingleHardCover=Class({onResize:function(b,c){if(this.leftPage)this.leftPage.onResize(b[0].x,b[0].y);
if(this.rightPage)this.rightPage.onResize(b[0].x,b[0].y);this.topSpine.onResize(c);this.bottomSpine.onResize(c);this.topSpine.setCSSByStyle({left:b[0].x+this.borderWidth+"px"});this.bottomSpine.setCSSByStyle({left:b[0].x+this.borderWidth+"px"});this.pagesWhArray=b;this.resizeCover(b[0].x,b[0].y,c);b=transformCSS({scale:{x:1,y:1}});this.leftPage&&this.leftPage.$page.css(b);this.rightPage&&this.rightPage.$page.css(b);this.topSpine.setCSSByStyle(b);this.bottomSpine.setCSSByStyle(b)},doSetMovingScale:function(b){b&&
(b=transformCSS({scale:{x:b.x,y:b.y}}),this.leftPage&&this.leftPage.$page.css(b),this.rightPage&&this.rightPage.$page.css(b),b=transformCSS({scale:{x:1,y:b.y}}),this.topSpine.setCSSByStyle(b),this.bottomSpine.setCSSByStyle(b))},initPage:function(){var b=BookInfo.getHardCoverPages(!1);bookConfig.RightToLeft&&(this.leftPage=new IssuuHardPage(b[0],"coverPage",!0,BookType.single_book));bookConfig.RightToLeft||(this.rightPage=new IssuuHardPage(b[0],"coverPage",!0,BookType.single_book));this.leftPage&&
this.cover.append(this.leftPage.$page);this.rightPage&&this.cover.append(this.rightPage.$page);this.leftPage&&this.leftPage.setLeftOrRight(!0);this.rightPage&&this.rightPage.setLeftOrRight(!1);this.leftPage&&this.leftPage.setCSSByStyle({top:"0",left:"0","margin-top":0,"margin-left":0});this.rightPage&&this.rightPage.setCSSByStyle({top:"0",right:"0","margin-top":0,"margin-right":0})},getSensitiveIndex:function(){return BookInfo.getSensitiveIndex(!1)},initBookSpine:function(){this.topSpine=new IssuuSingleBookSpine(this.cover);
this.bottomSpine=new IssuuSingleBookSpine(this.cover);this.topSpine.setCSSByName("top_spine");this.bottomSpine.setCSSByName("botoom_spine")},resizeCover:function(b,c,d){this.thicknessWidthArray=d;this.width=b+(d[0]+d[1])+this.borderWidth;this.height=c+2*this.borderWidth;this.cover.css({width:this.width+"px",height:this.height+"px",left:(bookConfig.RightToLeft?-(this.borderWidth+d[0]):0)+"px",top:-this.borderWidth+"px"})}}).extend(IssuuHardCover),IssuuSingleBookSpine=Class({onResize:function(b){this.width=
b[0]+b[1];this.bookSpine.css({width:this.width});bookConfig.RightToLeft?this.bookSpine.css({left:"auto",right:"0"}):this.bookSpine.css({right:"auto",left:"0"})}}).extend(IssuuBookSpine),IssuuPageAttachmentsParser=function(b,c,d,e,f,g,h,k,l){this.parent=b;this.width=c;this.page=k;this.height=d;this.pageWidth=e;this.pageHeight=f;this.pageIndex=g;this.bookType=h;this.callback=l;this.createAttachmentsForPage()};
IssuuPageAttachmentsParser.prototype.createAttachmentsForPage=function(){this.Items=new ObjectPool;this.factory=new PageAttachmentsFactory;this.isHiddenEditor()||getArticleEditor().then(this.createAnimation.bind(this));this.createAnnotation();this.highlightSearch()};IssuuPageAttachmentsParser.prototype.isHiddenEditor=function(){return!bookConfig.isPreview||bookConfig.previewPages&&-1!==(Array.isArray(bookConfig.previewPages)&&bookConfig.previewPages.indexOf(this.pageIndex))?!1:!0};
...
k.parent=h,l=k,m.yield(getPageDir(b,c,originTotalPageCount),2);l.imageURL=m.yieldResult;k.$content=$("<div style='position:absolute;left:0;top:0;width:100%;height:100%;'></div>");k.pdfLoadingTask=new PdfLoadingTask(k.index,k.type,e,f,k.loaded.bind(k));window.pdfLoadStack||(window.pdfLoadStack=new PdfLoadArray(3));window.pdfLoadStack&&pdfLoadStack.push(k.pdfLoadingTask);m.jumpToEnd()})},enterSide:function(){this.enter=!0},leaveSide:function(){this.enter=!1;this.pdfLoadingTask&&this.pdfLoadingTask.leaveSide()},
...
c}var d={width:"100%",height:"100%",position:"absolute",top:0,left:0};2>=b-this.width&&(d.width=this.width+"px",d.left=Math.round((b-this.width)/2)+"px");2>=c-this.height&&(d.height=this.height+"px",d.top=Math.round((c-this.height)/2)+"px");this.$canvas.css(d);d=transformCSS({scaleX:this.pageWidth/b,scaleY:this.pageHeight/c,origin:{x:0,y:0}},!1);this.$content.css(d);this.$content.css({width:b+"px",height:c+"px"})},resizeSvg:function(b,c){this.renderWidth=b;this.renderHeight=c;this.zoom=this.renderHeight>
this.pageHeight?!0:!1;window.pdfLoadStack&&(isPC()||isSlideBook()||0<=BookInfo.getCurrentPages().indexOf(this.index))&&(this.pdfLoadingTask.changeRenderWH(b,c),pdfLoadStack.push(this.pdfLoadingTask))},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),IsuuPageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==
q.nextAddress){if(!b||!c)return q.return();k.type=c;k.pageWidth=e;k.pageHeight=f;return q.yield(getPageDir(b,c,originTotalPageCount),2)}l=q.yieldResult;m=getPageSize(b,c);k.imageURL=l;k.load=null;k.parent=h;p=k.getUrlType(l,m);k.urlType=p;switch(p){case 0:k.load=new CanvasLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 1:k.load=new IssuuImageLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 2:k.load=new JsLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 3:k.load=new SvgLoad(b,c,d,k.pageWidth,
k.pageHeight,g,h);break;case 4:k.load=new IssuuImageArrayLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 5:k.load=new IssuuPdfLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 6:k.load=new ImageStageLoad(b,c,d,k.pageWidth,k.pageHeight,g,h);break;case 7:k.load=new NoneLoad(b,c,d,k.pageWidth,k.pageHeight,g,h)}q.jumpToEnd()})},getUrlType:function(b,c){return this.isPdf(b)?5:c&&isPC()?6:"object"==typeof b?4:"normal"==this.type&&bookConfig.usePdfJs?0:-1<b.indexOf("none")?7:-1<b.indexOf(".js")?2:
-1<b.indexOf(".svg")?3:1},isPdf:function(b){return-1<b.indexOf(".pdf")||-1<b.indexOf(".zip")?!0:!1},onResize:function(b,c){this.pageWidth=b;this.pageHeight=c;if(this.load&&this.load.onResize)this.load.onResize(b,c)},zoomIn:function(b,c){this.load&&this.load.zoomIn&&this.load.zoomIn(b,c)},zoomOut:function(b,c){this.load&&this.load.zoomOut&&this.load.zoomOut(b,c)},destroy:function(){this.load&&this.load.destroy&&this.load.destroy()},resizeSvg:function(b,c){this.load&&this.load.resizeSvg&&this.load.resizeSvg(b,
c)},enterSide:function(){this.load&&this.load.enterSide&&this.load.enterSide()},leaveSide:function(){this.load&&this.load.leaveSide&&this.load.leaveSide()}}),IssuuPageFlipShadow=Class({create:function(b,c){this.parent=b;this.pageIndex=c;this.init()},init:function(){this.flipShadowContent=$("<div style='pointer-events:none;width:100%;height:100%;position:absolute;z-index:100;left:0;top:0;'></div>");bookConfig.FlipDirection?(this.flipBackShadow=$("<div class='flip-vertical-shadowB'></div>"),this.flipFrontShadow=
$("<div class='flip-vertical-topshadow'></div>")):(this.flipBackShadow=$("<div class='flip-shadowB'></div>"),this.flipFrontShadow=$("<div class='flip-topshadow'></div>"));this.flipShadowContent.append(this.flipBackShadow);this.flipShadowContent.append(this.flipFrontShadow);this.parent.append(this.flipShadowContent)},setCSSByStyle:function(b){this.flipShadowContent.css(b)},flip:function(b,c,d){var e=b.shadowRate;d=b.rotate;var f=.9<e?1+2*(1-e)/.1:3*e/.9;if(isPhone()||isPad())f=1;e=.9<e?.2*(1-e)/.1:
.1>e?.2*e/.1:.2;if(bookConfig.FlipDirection){var g=transformCSS({scaleY:f,rotate:-d,tran:{x:0,y:(b.frontShadowDistance-100*(90<d?0:f))/Math.cos(d*Math.PI/180)}});b=transformCSS({scaleY:f,rotate:d,tran:{x:-b.maskTranY,y:b.maskTranX}})}else g=transformCSS({scaleX:f,rotate:-d,tran:{x:(b.frontShadowDistance-100*(90<d?0:f))/Math.cos(d*Math.PI/180),y:0}}),b=transformCSS({scaleX:f,rotate:d,tran:{x:b.maskTranX,y:b.maskTranY}});this.flipFrontShadow.css(g);this.flipBackShadow.css(b);this.beforeFlip(d,c);isPhone()||
isPad()||(this.flipFrontShadow.css({opacity:e}),this.flipBackShadow.css({opacity:e}))},beforeFlip:function(b,c){c?(this.flipBackShadow&&this.flipBackShadow.css({visibility:"hidden"}),this.flipFrontShadow&&this.flipFrontShadow.css({visibility:"visible"})):(this.flipBackShadow&&this.flipBackShadow.css({visibility:"visible"}),this.flipFrontShadow&&this.flipFrontShadow.css({visibility:"hidden"}));bookConfig.FlipDirection?(90<b?(this.flipFrontShadow.css({bottom:"0px"}),this.flipBackShadow.css({top:"100%"})):
(this.flipFrontShadow.css({bottom:"auto"}),this.flipBackShadow.css({top:"0px"})),c=0<=b&&180>b?100/3:100*(this.width+this.maskWidth)/(3*this.maskWidth),b=90<b?100:0):(90<b?(this.flipFrontShadow.css({right:"0px"}),this.flipBackShadow.css({left:"100%"})):(this.flipFrontShadow.css({right:"auto"}),this.flipBackShadow.css({left:"0px"})),c=90<b?100:0,b=0<=b&&180>b?100*(this.height+this.maskWidth)/(3*this.maskWidth):100/3);this.flipFrontShadow.css({"transform-origin":c+"% "+b+"%","-webkit-transform-origin":c+
"% "+b+"%","-moz-transform-origin":c+"% "+b+"%","-ms-transform-origin":c+"% "+b+"%"})},clear:function(){this.flipBackShadow&&this.flipBackShadow.css({visibility:"hidden"});this.flipFrontShadow&&this.flipFrontShadow.css({visibility:"hidden"})},resize:function(b,c){this.width=b;this.height=c;this.maskWidth=parseInt(Math.sqrt(Math.pow(b,2)+Math.pow(c,2)));bookConfig.FlipDirection?(this.flipFrontShadow.css({width:3*this.maskWidth,left:-this.maskWidth}),this.flipBackShadow.css({width:this.maskWidth,left:(this.width-
this.maskWidth)/2})):(this.flipFrontShadow.css({height:3*this.maskWidth,top:-this.maskWidth}),this.flipBackShadow.css({height:this.maskWidth,top:(this.height-this.maskWidth)/2}))}});
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,B){if(!b)return!1;var w=b.pageWidth,v=b.pageHeight,u=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(B=u(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(v*v-B*B):v-f*Math.sqrt(w*w-B*B));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
c;this.maskWidth=parseInt(Math.sqrt(b*b+c*c));0!=(this.maskWidth-this.height)%2&&(this.maskWidth+=1);this.setCSS({width:this.width,height:this.height});this.resizePage(this.pageWidth,this.pageHeight,d);this.resetBookShadow(this.currentPageIndex)},resizePage:function(b,c,d){b=this.getFitWHByIndex(this.currentPageIndex);var e=BookInfo.getLeftPages(this.currentPageIndex);c=BookInfo.getRightPages(this.currentPageIndex);for(var f=0;f<e.length;f++){var g=this.pageArray[e[f]];if(g)if(d)g.onResize(g.pageWidth*
...
g[0].x)-0,f);e={tran:{x:parseInt(this.movedX),y:0}};this.status_zoom||this.setCSS(e);this.bookAttachments.Items.find("ThicknessManager").each(function(q){q.leftThickness&&q.leftThickness.doSetMovingScale(b,c,d,f,!1,p.y,(-p.x+1)*g[0].x);q.rightThickness&&q.rightThickness.doSetMovingScale(b,c,d,f,!1,m.y,(m.x-1)*g[1].x)}.bind(this))}}},getDownUpPage:function(b,c){this.addPageArray([b,c]);var d=this.getFitWHByIndex(this.currentPageIndex);d=transformCSS({tran:{x:-d[1].x,y:0},origin:{x:100,y:50}});this.pageArray[b]&&
(this.pageArray[b].beginToFlip(),this.pageArray[b].setCSSByStyle(d));this.pageArray[c]&&(this.pageArray[c].beginToFlip(),this.pageArray[c].setCSSByStyle(d));this.pageArray[b]&&(this.pageArray[b].page.setCSSByName("right-flip-side"),this.setZIndexByPageIndex(this.pageArray[b]));this.pageArray[c]&&(this.pageArray[c].page.setCSSByName("flip-side"),this.pageArray[c].page.side.addClass("boxShadow"),this.setZIndexByPageIndex(this.pageArray[c]));return[this.pageArray[b],this.pageArray[c]]},getMovedXByIndex:function(b){var c=
...
{x:m,y:p},q.rotateY?(q.$page[0].style.removeProperty("transform-origin"),d=void 0,B=transformCSS({scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,B=transformCSS({origin:g,scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(B);if(q.page.pageFlipShadow){var w=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(w)}}}return{x:m,y:p}}catch(v){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
...
g[0],h[0],{x:0,y:50}));this.movedX=$.easing.easeInOutSine(null,b<c?d:f-d,0,e-0,f);e={tran:{x:parseInt(this.movedX),y:0}};this.status_zoom||this.setCSS(e);this.bookAttachments.Items.find("ThicknessManager").each(function(l){l.leftThickness&&l.leftThickness.hide();l.rightThickness&&l.rightThickness.doSetMovingScale(b,c,d,f,!1,k.y,(k.x-1)*g[0].x)}.bind(this));this.hardCover&&this.hardCover.doSetMovingScale(k)}}},getDownUpPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);
b=this.getFitWHByIndex(this.currentPageIndex);b=transformCSS({tran:{x:-b[1].x,y:0},origin:{x:100,y:50}});this.pageArray[d]&&(this.pageArray[d].beginToFlip(),this.pageArray[d].setCSSByStyle(b));this.pageBackArray[d]&&(this.pageBackArray[d].beginToFlip(),this.pageBackArray[d].setCSSByStyle(b));this.pageArray[d]&&this.pageArray[d].page.setCSSByName("right-flip-side");this.pageBackArray[d]&&(this.pageBackArray[d].page.setCSSByName("flip-side"),this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],
this.pageBackArray[d]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){var m=this;try{var p=1,q=1;p=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);q=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(w){if(w){var v=transformCSS({tran:l?l:{x:0,y:0},scale:{x:p,y:q},origin:g});if(m.isCoverPage(w.pageIndex))if(w.tran=
l?l:{x:0,y:0},w.scale={x:p,y:q},w.rotateY){w.$page[0].style.removeProperty("transform-origin");var u;v=transformCSS({scale:{x:p,y:q},perspective:6E3,rotateY:null!=(u=w.rotateY)?u:0})}else{var x;v=transformCSS({origin:g,scale:{x:p,y:q},perspective:6E3,rotateY:null!=(x=w.rotateY)?x:0})}w.setCSSByStyle(v);v=h?transformCSS({scale:{x:k.x/p,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});w.page.pageFlipShadow&&w.page.pageFlipShadow.setCSSByStyle(v)}};for(d=0;d<b.length;d++){var B=this.pageBackArray[b[d]];
c(this.pageArray[b[d]]);c(B)}return{x:p,y:q}}catch(w){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&pageList[b[f]-1]?pageList[b[f]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):e.push({width:0,height:bookConfig.largePageHeight});f=e[0].height;b=
e[0].width;e=e[1]?f*e[1].width/e[1].height:0;c=fitPageWidthHeight(c,d,b+e,f);d=[];d.push({x:Math.round(b/(b+e)*c.x),y:Math.round(c.y)});d.push({x:Math.round(e/(b+e)*c.x),y:Math.round(c.y)});return d},getPagesFitWHByIndex:function(b){this.getSpace(!1);var c=this.getSpace(!0);b=window.pageList&&pageList[b-1]?pageList[b-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight};c=fitPageWidthHeight(windowWidth-c.left-c.right,windowHeight-c.top-c.bottom,b.width,b.height);return{x:Math.round(c.x),
y:Math.round(c.y)}},getSpace:function(b){var c=bookConfig.leftMargin+templateArea.getLeftWidth(),d=bookConfig.rightMargin+templateArea.getRightWidth(),e=bookConfig.topMargin+templateArea.getTopHeight(),f=bookConfig.bottomMargin+templateArea.getBottomHeight();b&&(c+=rightToLeft?bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1):0,d+=rightToLeft?0:bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1),e+=bookConfig.hardCoverBorderWidth,f+=bookConfig.hardCoverBorderWidth);return{left:c,right:d,
top:e,bottom:f}},afterZoomIn:function(b){b&&this.flipBook.parameters&&!this.flipBook.parameters.resize&&(this._super(b),this.bookAttachments.afterZoomIn(this.width,this.height))},getCurrentPageWidthHeight:function(b){this.edgeX();b=this.getFitWHByIndex(this.currentPageIndex);return{pageWidth:b[0].x,pageHeight:b[0].y}},realPoint:function(b){if((b=b.originalEvent&&b.originalEvent.changedTouches?b.originalEvent.changedTouches:b.changedTouches?b.changedTouches:[b])&&!(3<=b.length)){var c=this.realBookPosition()[0],
d=this.realBookPosition()[1],e=b[0].pageX,f=b[0].pageY;bookConfig.upsideOnMobile()&&(e=b[0].pageY,f=windowHeight-b[0].pageX);var g=this.getFitWHByIndex(this.currentPageIndex);if(bookConfig.FlipDirection){f=f-d-g[0].y;var h=this.getCurrentPageWidthHeight(f),k=h.pageWidth;e=this.pageWidth-(e-c)-(this.pageWidth-k)/2;if(!b[1])return[{x:f,y:e}];h=b[1].pageX;b=b[1].pageY;h=this.pageWidth-(h-c)-(this.pageWidth-k)/2;b=b-d-g[0].y;return[{x:f,y:e},{x:b,y:h}]}e=e-c-g[0].x;h=this.getCurrentPageWidthHeight(e);
k=h.pageHeight;f=f-d-(this.pageHeight-k)/2;if(!b[1])return[{x:e,y:f}];h=b[1].pageX;b=b[1].pageY;h=h-c-g[0].x;b=b-d-(this.pageHeight-k)/2;return[{x:e,y:f},{x:h,y:b}]}}}).extend(IssuuSingleFlipBook),HardIssuuBook=Class({bookType:BookType.normal_book,doublePage:!0,create:function(b){bookConfig.bookPageStretch=!0;this._super(b);this.resetZoomArea();bookConfig.supportSerialsFlip=!1},crossFlipMode:function(b){var c=this.currentPageIndex;return 0<=[1,totalPageCount].indexOf(c)&&0<=[1,totalPageCount].indexOf(b)||
...
[1,totalPageCount].indexOf(b);return!0},toHardPage:function(b){return!1},toCoverPage:function(b){var c=this.currentPageIndex;return 0>[1,2,totalPageCount-1,totalPageCount].indexOf(c)&&0>[1,2,totalPageCount-1,totalPageCount].indexOf(b)||0<=[2,3].indexOf(c)&&0>[1,totalPageCount].indexOf(b)||0>[1,totalPageCount].indexOf(c)&&0>[1,totalPageCount].indexOf(b)?!1:!0},isHardPage:function(b,c){return!1},isCoverPage:function(b,c){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?!0:!1},gotoNearPage:function(b){1==
this.currentPageIndex?gotoPageFun(2,!1,"cross page"):this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):b==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):1==b&&gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=new IssuuHardCover(this.flipBook)},newPage:function(b){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?new IssuuHardPage(b,"page",!1,BookType.normal_book):new IssuuNormalPage(b,"page",!1,BookType.normal_book)},
followToPoint:function(b,c,d){this._super(b,c,d);this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth())},getDownUpHardPage:function(b,c,d){this.addPageArray([b,c]);d?(this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!0),this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!1),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-left-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-right-side"),bookConfig.RightToLeft||b!=totalPageCount||this.pageArray[c].setCSSByName("flip-hard-right-last-side"),
bookConfig.RightToLeft&&1==b&&this.pageArray[c].setCSSByName("flip-hard-right-last-side")):(this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!1),this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!0),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-right-side"),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-left-side"),bookConfig.RightToLeft||1!=b||this.pageArray[c].setCSSByName("flip-hard-left-first-side"),bookConfig.RightToLeft&&b==totalPageCount&&this.pageArray[c].setCSSByName("flip-hard-left-first-side"));
return[this.pageArray[b],this.pageArray[c]]},setAttachmentBeforeFlipTo:function(b){this._super(b);this.hardCover&&this.hardCover.refresh(b,this.getThicknessWidth(),this.currentPageIndex)},afterCurling:function(){this._super();this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},movetoCenter:function(b,c,d){if(bookConfig.retainBookCenter){var e=this.getMovedXByIndex(c).x-this.getMovedXByIndex(b).x,f=this.width;if(void 0==d||d>f)d=f;if(!isNaN(d)){this.movedLength=
...
c,d,f,!1,p.y,(-p.x+1)*g[0].x);q.rightThickness&&q.rightThickness.doSetMovingScale(b,c,d,f,!1,m.y,(m.x-1)*g[1].x)}.bind(this));this.hardCover.doSetMovingScale(p,m)}}},setAttachmentAfterFlipTo:function(b){this._super(b);this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},onResize:function(b,c){this._super(b,c);this.hardCover.onResize(this.getFitWHByIndex(this.currentPageIndex),this.getThicknessWidth());this.hardCover.refresh(this.currentPageIndex,
this.getThicknessWidth(),this.currentPageIndex)},resizeBook:function(b,c,d){this._super(b,c,d);var e=this.getFitWHByIndex(this.currentPageIndex);b=BookInfo.getLeftPages();c=BookInfo.getRightPages();d&&(e=[{x:b[0]&&this.pageArray[b[0]]?this.pageArray[b[0]].pageWidth:0,y:b[0]&&this.pageArray[b[0]]?this.pageArray[b[0]].pageHeight:0},{x:c[0]&&this.pageArray[c[0]]?this.pageArray[c[0]].pageWidth:0,y:c[0]&&this.pageArray[c[0]]?this.pageArray[c[0]].pageHeight:0}]);this.hardCover.onResize(e,this.getThicknessWidth());
this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},isHardPage:function(b,c){return!1},isCoverPage:function(b,c){return 1==b||2==b||b==totalPageCount||b==totalPageCount-1?!0:!1},getThicknessWidth:function(){var b=[0,0];this.bookAttachments.Items.find("ThicknessManager").each(function(c){b=c.getThicknessWidth()});return b},show:function(){this._super();this.hardCover.show()},hide:function(){this._super();this.hardCover.hide()}}).extend(IssuuBook),SingleHardIssuuBook=
Class({bookType:BookType.single_book,create:function(b){this._super(b)},crossFlipMode:function(b){var c=this.currentPageIndex;return 1==c&&2!=b||2!=c&&1==b?!0:!1},toSoftPage:function(b){return 2==b||1==b?!1:!0},toHardPage:function(b){return!1},toCoverPage:function(b){return 1!=b?!1:!0},isCoverPage:function(b,c){var d=b;b>c&&(d=c);return 1==d||d==bookConfig.totalPageCount?!0:!1},isHardPage:function(b,c){return!1},gotoNearPage:function(b){1==this.currentPageIndex?gotoPageFun(2,!1,"cross page"):1==b&&
gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=new IssuuSingleHardCover(this.flipBook)},newPage:function(b){1==b||b==bookConfig.totalPageCount?(b=new IssuuHardPage(b,"page",!0,BookType.single_book),b.setLeftOrRight(bookConfig.RightToLeft)):b=new IssuuNormalPage(b,"page",!0,BookType.single_book);return b},newPageBack:function(b){1==b||b==bookConfig.totalPageCount?(b=new IssuuHardPage(b,"pageBack",!0,BookType.single_book,!0),b.setLeftOrRight(bookConfig.RightToLeft)):
b=new IssuuNormalPage(b,"pageBack",!0,BookType.single_book,!0);return b},followToPoint:function(b,c,d){this._super(b,c,d);this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth())},getThicknessWidth:function(){var b=[0,0];this.bookAttachments.Items.find("ThicknessManager").each(function(c){b=c.getThicknessWidth()});return b},getDownUpHardPage:function(b,c){var d=b;b>c&&(d=c);this.addPageArray([d]);this.addPageBackArray([d]);bookConfig.RightToLeft?(this.pageArray[d]&&this.pageArray[d].setLeftOrRight(!0),
this.pageBackArray[d]&&this.pageBackArray[d].setLeftOrRight(!0),this.pageArray[d]&&this.pageArray[d].setCSSByName("flip-hard-left-side"),this.pageBackArray[d]&&this.pageBackArray[d].setCSSByName("flip-hard-right-side")):(this.pageArray[d]&&this.pageArray[d].setLeftOrRight(!1),this.pageBackArray[d]&&this.pageBackArray[d].setLeftOrRight(!1),this.pageArray[d]&&this.pageArray[d].setCSSByName("flip-hard-right-side"),this.pageBackArray[d]&&this.pageBackArray[d].setCSSByName("flip-hard-left-side"));return[this.pageArray[d],
this.pageBackArray[d]]},setAttachmentBeforeFlipTo:function(b){this._super(b);this.hardCover&&this.hardCover.refresh(b,this.getThicknessWidth(),this.currentPageIndex)},afterCurling:function(){this._super();this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},setAttachmentAfterFlipTo:function(b){this._super(b);this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},resizeBook:function(b,c,
d){this._super(b,c,d);c=this.getFitWHByIndex(this.currentPageIndex);b=BookInfo.getCurrentPages();d&&(c=[{x:b[0]&&this.pageArray[b[0]]?this.pageArray[b[0]].pageWidth:0,y:b[0]&&this.pageArray[b[0]]?this.pageArray[b[0]].pageHeight:0},{x:0,y:0}]);this.hardCover.onResize(c,this.getThicknessWidth());this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},show:function(){this._super();this.hardCover.show()},hide:function(){this._super();this.hardCover.hide()}}).extend(SingleIssuuBook),
BookEvent=Class({statics:{bindEvent:function(b,c){"string"==typeof b&&c&&"function"==typeof c&&(this[b]||(this[b]=[]),this[b].push(c))},bindOnceEvent:function(b,c){if("string"===typeof b&&c&&"function"===typeof c){var d=function(e){for(var f=[],g=0;g<arguments.length;++g)f[g-0]=arguments[g];f=c.apply(this,f);this.removeEvent(b,d);return f}.bind(this);this[b]||(this[b]=[]);this[b].push(d)}},removeEvent:function(b,c){"string"==typeof b&&c&&"function"==typeof c&&this[b].removeElement(c)},trigger:function(b,
