...
getConfigValue("autoDoublePage","auto");"docview"===tmpBookConfig.FlipStyle&&(tmpBookConfig.autoDoublePage="single");b=tmpBookConfig.autoDoublePage?tmpBookConfig.autoDoublePage.toLocaleLowerCase():"auto";"single"!=b&&"auto"!=b&&"double"!=b?getConfigValue("autoDoublePage",!0)?tmpBookConfig.showDoublePage="auto":tmpBookConfig.showDoublePage="single":tmpBookConfig.showDoublePage=b;tmpBookConfig.alwaysDoublePageOnMobile=getConfigValue("alwaysDoublePageOnMobile",!1);tmpBookConfig.upsideOnMobile=function(){return isPhone()||
...
try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(c=0;c<window.ignoreModuleArray.bookConfig.length;c++){var d=window.ignoreModuleArray.bookConfig[c];void 0!=tmpBookConfig[d]&&(tmpBookConfig[d]=!1)}}catch(e){}checkFliphtml5PagesConfig();checkFlipStyleConfig();"issuu"==tmpBookConfig.FlipStyle?loadCss(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"):loadCss(tmpBookConfig.UIBaseURL+"style/flipbook.min.css");checkPageEditorConfig();recordError();c=Module._getVerifyString();d=UTF8ToString(c);
Module._free(c);eval(d)};function recordError(){try{var b=window.setInterval(function(){window.onBookError&&(tmpBookConfig.largePageWidth&&tmpBookConfig.largePageHeight&&tmpBookConfig.totalPageCount||BookEvent.trigger("errorLog",[JSON.stringify({largePageWidth:tmpBookConfig.largePageWidth,largePageHeight:tmpBookConfig.largePageHeight,totalPageCount:tmpBookConfig.totalPageCount,type:"BookConfigError"})]),window.clearInterval(b))},500)}catch(c){}}
...
var VERSION_NAME="6.4.9",BUILD_DATE="2025050601",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType={WEBKIT:1,
